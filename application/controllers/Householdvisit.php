...
class Householdvisit extends BaseController
{
  ...
  /*  public function split()
                ...
                $event = $this->input->post('event', true);
                 ...
                 if( ($this->input->post('submit') == 'Save & Next'))
                 {
					 ...
					 //print_r($this->input->post()); die();
                       ...
                       if ($countRow > 0)
                       {
                          $this->session->set_flashdata('error', 'Asset alreay exists for this round so you cannot marks as no/not available.');
                          redirect('householdvisit/assets?baseID='.$baseID.'#asset');
                       }
                        ...
                        if ($householdVisitID > 0)
                        {
                            ...
                            try
                            {
                                ...
                                $visitData = array(
                                    'any_asset' => $this->input->post('assetType'),
                                    'transfer_complete' => 'No',
                                    'updateBy' => $this->vendorId,
                                    'updatedOn' => date('Y-m-d H:i:s')
                                );
                       ...
                       if ($countRow > 0)
                       {
                        ...
                        if ($householdVisitID > 0)
                        {
                            ...
                            try
                            {
                                ...
                                $visitData = array(
                                    'any_migration_in' => $this->input->post('miginType'),
                                    'transfer_complete' => 'No',
                                    'updateBy' => $this->vendorId,
                                    'updatedOn' => date('Y-m-d H:i:s')
                                );
    ...
    public function migout()
    {
            ...
            if( $this->input->post('submit'))
            {
                ...
                $event = $this->input->post('event', true);
                 ...
                 if( ($this->input->post('submit') == 'Save & Complete'))
                 {
                       ...
                       // }
                        ...
                        if ($householdVisitID > 0)
                        {
                            ...
                            try
                            {
                                ...
                                $visitData = array(
                                    'any_migration_out' => $this->input->post('migoutType'),
                                    'transfer_complete' => 'No',
                                    'updateBy' => $this->vendorId,
                                    'updatedOn' => date('Y-m-d H:i:s')
                                );
						    ...
						    $this->session->set_flashdata('success', 'Household visit successfully');
							$this->session->unset_userdata('household_master_id_sub');
							redirect('householdvisit/visit?baseID='.$baseID);
                       ...
                       if ($countRow > 0)
                       {
                        ...
                        if ($householdVisitID > 0)
                        {
                            ...
                            try
                            {
                                ...
                                $visitData = array(
                                    'any_marriage_start' => $this->input->post('mstartType'),
                                    'transfer_complete' => 'No',
                                    'updateBy' => $this->vendorId,
                                    'updatedOn' => date('Y-m-d H:i:s')
                                );
                       ...
                       if ($countRow > 0)
                       {
                        ...
                        if ($householdVisitID > 0)
                        {
                            ...
                            try
                            {
                                ...
                                $visitData = array(
                                    'any_marriage_end' => $this->input->post('mendType'),
                                    'transfer_complete' => 'No',
                                    'updateBy' => $this->vendorId,
                                    'updatedOn' => date('Y-m-d H:i:s')
                                );
                       ...
                       if ($countRow > 0)
                       {
                        ...
                        if ($householdVisitID > 0)
                        {
                            ...
                            try
                            {
                                ...
                                $visitData = array(
                                    'any_concepton' => $this->input->post('conceptType'),
                                    'transfer_complete' => 'No',
                                    'updateBy' => $this->vendorId,
                                    'updatedOn' => date('Y-m-d H:i:s')
                                );
                       ...
                       if ($countRow > 0)
                       {
                        ...
                        if ($householdVisitID > 0)
                        {
                            ...
                            try
                            {
                                ...
                                $visitData = array(
                                    'any_pregnancy' => $this->input->post('pregType'),
                                    'transfer_complete' => 'No',
                                    'updateBy' => $this->vendorId,
                                    'updatedOn' => date('Y-m-d H:i:s')
                                );
                       ...
                       if (!empty($countRow))
                       {
                        ...
                        if ($householdVisitID > 0)
                        {
                            ...
                            try
                            {
                                ...
                                $visitData = array(
                                    'any_birth' => $this->input->post('birthType'),
                                    'transfer_complete' => 'No',
                                    'updateBy' => $this->vendorId,
                                    'updatedOn' => date('Y-m-d H:i:s')
                                );
                       ...
                       if ($countRow > 0)
                       {
                        ...
                        if ($householdVisitID > 0)
                        {
                            ...
                            try
                            {
                                ...
                                $visitData = array(
                                    'any_education' => $this->input->post('eduType'),
                                    'transfer_complete' => 'No',
                                    'updateBy' => $this->vendorId,
                                    'updatedOn' => date('Y-m-d H:i:s')
                                );
                       ...
                       if ($countRow > 0)
                       {
                        ...
                        if ($householdVisitID > 0)
                        {
                            ...
                            try
                            {
                                ...
                                $visitData = array(
                                    'any_occupation' => $this->input->post('occuType'),
                                    'transfer_complete' => 'No',
                                    'updateBy' => $this->vendorId,
                                    'updatedOn' => date('Y-m-d H:i:s')
                                );
                       ...
                       if ($countRow > 0)
                       {
                        ...
                        if ($householdVisitID > 0)
                        {
                            ...
                            try
                            {
                                ...
                                $visitData = array(
                                    'any_relation' => $this->input->post('relType'),
                                    'transfer_complete' => 'No',
                                    'updateBy' => $this->vendorId,
                                    'updatedOn' => date('Y-m-d H:i:s')
                                );
                       ...
                       if ($countRow > 0)
                       {
                        ...
                        if ($householdVisitID > 0)
                        {
                            ...
                            try
                            {
                                ...
                                $visitData = array(
                                    'any_death' => $this->input->post('deathType'),
                                    'transfer_complete' => 'No',
                                    'updateBy' => $this->vendorId,
                                    'updatedOn' => date('Y-m-d H:i:s')
                                );
	...
	public function immunization()
    {
            ...
            $this->global['pageTitle'] = $this->config->item('prefix'). ' : Immunization' ;
            $data['pageTitle'] = $this->pageTitle;
            $data['controller'] = $this->controller;
            $data['addMethod'] = 'addNew';
            $data['editMethod'] = 'editOld';
            ...
            if( $this->input->post('submit'))
            {
                ...
                $householdVisitID = $this->input->post('householdVisitID', true);
                 ...
                 if( ($this->input->post('submit') == 'Save & Next'))
                 {
                       ...
                       $countRow = $this->db->select('count(id) as countRow')->from($this->config->item('memberImmunizationTable'))->where($whereHouseholdDeath)->get()->row()->countRow;

                       if ($countRow > 0)
                       {
                          $this->session->set_flashdata('error', 'Immunization alreay exists for this round so you cannot marks as no.');
                          redirect('householdvisit/immunization?baseID='.$baseID.'#immunization');
                       }
                        ...
                        if ($householdVisitID > 0)
                        {
                            ...
                            try
                            {
                                ...
                                $visitData = array(
                                    'any_immunization' => $this->input->post('immunizationType'),
                                    'transfer_complete' => 'No',
                                    'updateBy' => $this->vendorId,
                                    'updatedOn' => date('Y-m-d H:i:s')
                                );
                 ...
                 if( $this->input->post('submit') == 'Next')
                 {
					   ...
					   $whereHouseholdImmu= array('household_master_id' =>$household_master_id,'round_master_id'=>$round_master_id);

                       $countRow = $this->db->select('count(id) as countRow')->from($this->config->item('memberImmunizationTable'))->where($whereHouseholdImmu)->get()->row()->countRow;
            ...
            $data['householdVisit'] = $this->visitModel->getHouseholdVisitDet($this->config->item('householdVisitTable'),$data['household_master_id_sub'],$data['round_master_id']);
            $data['presentMemberList'] = $this->memberModel->getMemberMasterPresentListByHouseholdIdsforImmunization($data['household_master_id_sub']);

            $data['immunizationRecords']  = $this->immunizationModel->getRoundwiseImmunization($data['household_master_id_sub'],$data['round_master_id']);
	...
	public function child_illness() {
        ...
        $this->global['pageTitle'] = $this->config->item('prefix') . ' : Child Illness';
        $data['pageTitle'] = $this->pageTitle;
        $data['controller'] = $this->controller;
        $data['addMethod'] = 'addNew';
        $data['editMethod'] = 'editOld';
        ...
        if ($this->input->post('submit')) 
		{
            ...
            if (($this->input->post('submit') == 'Save & Next')) {
                ...
                $countRow = $this->db->select('count(id) as countRow')->from($this->config->item('memberChildIllnessTable'))->where($whereHouseholdDeath)->get()->row()->countRow;

                if ($countRow > 0) {
                    $this->session->set_flashdata('error', 'Child data alreay exists for this round so you cannot marks as no.');
                    redirect('householdvisit/child_illness?baseID=' . $baseID . '#child_illness');
                }
                ...
                if ($householdVisitID > 0) {
                    ...
                    try {
                        ...
                        $visitData = array(
                            'any_child_illness' => $this->input->post('childIllnessType'),
                            'transfer_complete' => 'No',
                            'updateBy' => $this->vendorId,
                            'updatedOn' => date('Y-m-d H:i:s')
                        );
           ...
           if( $this->input->post('submit') == 'Next')
                 {
                       ...
                       $countRow = $this->db->select('count(id) as countRow')->from($this->config->item('memberChildIllnessTable'))->where($whereHouseholdImmu)->get()->row()->countRow;
        ...
        $data['childIllnessRecords'] = $this->childIllnessModel->getRoundwisechildIllness($data['household_master_id_sub'], $data['round_master_id']);
    ...
    public function interview()
    {
            ...
            if( $this->input->post('submit'))
            {
                 ...
                 if( ($this->input->post('submit') == 'Save & Conmplete') || ($this->input->post('submit') == 'Save') || ($this->input->post('submit') == 'Save & Next') )
                 {
                    $household_master_id = $this->input->post('household_master_id_sub', true);
                    $round_master_id = $this->input->post('round_master_id', true);
                    $householdVisitID = $this->input->post('householdVisitID', true);
