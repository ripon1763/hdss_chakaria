           ...
           if($this->form_validation->run() == FALSE)
            ...
            else
            {
               ...
               // $fk_kazi_registered = $this->input->post('fk_kazi_registered',true);
			    ...
			    $member_code_name = $this->input->post('name',true);
               ...
               // $is_event = $this->input->post('is_event',true);
				...
				if (!empty($full_code))
				{
					...
					$member_code_name = $this->db->select('member_name')->from($this->config->item('memberMasterTable'))->where($wherememberCode)->get()->row()->member_name;
