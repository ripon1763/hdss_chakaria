...
class Household_master extends BaseController
{
    /**
     * This is default constructor of the class
     */
	 
	public $controller = "household_master";
	public $pageTitle = 'Household Management';
	public $pageShortName = 'Household Master';
    ...
    function addNew()
    {
	        ...
	        $data['pageTitle'] = $this->pageTitle;
			$data['controller'] = $this->controller;
			$data['actionMethod'] = 'addNewHousehold';
			$data['shortName'] = $this->pageShortName;
			$data['boxTitle'] = 'Add';
    ...
    function addNewHousehold()
    {
            ...
            //$this->form_validation->set_rules('leftSlum','Left Slum','trim|numeric');
            ...
            else
            {
               ...
               if ($this->getCurrentRound()[0]->active == 0)
               {
                ...
                { 
                    ...
                    $householdCodeData = $this->getHouseholdCode($slumID,$slumAreaID);

                    $householdCode =  $householdCodeData['householCode'];
                    $houseCount =  $householdCodeData['houseCount'];
    				...
    				$result = $this->modelName->addNewList($IdInfo,$this->config->item('householdMasterTable'));
                ...
                $this->session->set_flashdata('success', $this->pageShortName.' created successfully. household ID = '.$householdCode);
