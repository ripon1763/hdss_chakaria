...
class Lookup_master_va extends BaseController
{
    /**
     * This is default constructor of the class
     */
	 
	public $controller = "lookup_master_va";
	public $pageTitle = 'Lookup Master Management';
	public $pageShortName = 'Lookup Master';
    ...
    public function index()
    {
            ...
            $data['userRecords'] = $this->modelName->listing($this->config->item('lookMasterTable_va'));
    ...
    function addNewList()
    {
		   ...
		   if($this->form_validation->run() == FALSE)
            ...
            else
            {
				...
				$result = $this->modelName->addNewList($IdInfo,$this->config->item('lookMasterTable_va'));
    ...
    function editOld($id = NULL)
    {
		    ...
		    $this->global['menu'] =  $this->menuModel->getMenu($this->role);
            $data['userInfo'] = $this->modelName->getListInfo($id,$this->config->item('lookMasterTable_va'));
    ...
    function editList()
    {
            ...
            else
            {
                ...
                $IDInfo = array();
                $IDInfo = array( 'NAME'=> $name,'CODE'=> $code,'ACTIVE'=>$active,'DESCRIPTION'=>$description,'LAST_UPDATED_BY'=>$this->vendorId, 'UPDATE_TIMESTAMP'=>date('Y-m-d H:i:s'));
                
                $result = $this->modelName->editList($IDInfo, $id,$this->config->item('lookMasterTable_va'));
