...
class Master_va_model extends CI_Model
{
    ...
    {
        $this->db->select('ID, ACTIVE, CODE, CREATE_TIMESTAMP, CREATED_BY, DESCRIPTION, LAST_UPDATED_BY, NAME, UPDATE_TIMESTAMP');
        $this->db->from($tableName);
        $query = $this->db->get();
    ...
    {
        $this->db->select('a.ID, a.ACTIVE, a.CODE, a.CREATE_TIMESTAMP, a.CREATED_BY, a.DESCRIPTION, 
		a.NAME, a.DISPLAY_ORDER,a.INTERNAL_CODE, a.LOOKUP_MASTER_ID, b.NAME as lookup_master_name');
        $this->db->from($tableName. ' as a');
		$this->db->join('lookup_master_va b', 'b.ID = a.LOOKUP_MASTER_ID', 'left');
    ...
    {
        $this->db->select('ID, ACTIVE, CODE, CREATE_TIMESTAMP, CREATED_BY, DESCRIPTION, DISPLAY_ORDER, INTERNAL_CODE, LAST_UPDATED_BY, LOOKUP_MASTER_ID, NAME, UPDATE_TIMESTAMP');
        $this->db->from($tableName);
        $this->db->where('id', $id);
        $query = $this->db->get();
