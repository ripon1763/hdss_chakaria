...
class MemberMarriage_model extends CI_Model
{
    ...
    function getMarriageStartDetailsByIdnHousehold($id,$household_master_id,$round_master_id)
    {
		...
		marriage_date, fk_bri_gem_premarital_status, fk_bri_gem_marital_order, fk_kazi_registered, fk_member_premarital_status, mar.name, mar.age,mar.dob,
    ...
    {
        $this->db->select('mar.id, mar.household_master_id,mar.member_master_id,mm.member_code, mar.round_master_id,mm.member_name,mm.birth_date, roundNo,
		 marriage_end_date, fk_marriage_end_cause_one, fk_marriage_end_cause_two, fk_marriage_end_cause_three, fk_marriage_end_type, mar.name, mar.age,mar.dob,
