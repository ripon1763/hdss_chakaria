...
<?php $baseID = $this->input->get('baseID',TRUE); ?>
 ...
 $fk_preg_complication = 0;
 $fk_delivery_complication = 0;
 $fk_preg_violence = 0;

 $fk_supliment = 0;

$fk_anc_first_assist_id = 0;
$fk_anc_second_assist_id = 0;
$fk_anc_third_assist_id = 0;
$fk_anc_fourth_assist_id = 0;
$fk_anc_fifth_assist_id = 0;                   
$fk_anc_supliment = 0;
$fk_supliment_received_way = 0;
$fk_how_many_tab = 0;
$totalnumbertab = 0;
$fk_anc_weight_taken = 0;
$fk_anc_blood_pressure = 0;
$fk_anc_urine = 0;
$fk_anc_blood = 0;
$fk_anc_denger_sign = 0;
$fk_anc_nutrition = 0;
$fk_anc_birth_prepare = 0;
$fk_anc_soap = 0;
$fk_anc_delivery_kit = 0;
$fk_anc_care_chix = 0;
$fk_anc_dried = 0;
$fk_anc_bathing = 0;
$fk_anc_breast_feed = 0;
$fk_anc_skin_contact = 0; 
$fk_anc_enc = 0;
$fk_suspecred_infection = 0;
$fk_baby_antibiotics = 0;
$fk_prescribe_antibiotics = 0; 
$fk_seek_treatment = 0;
$fk_anc_vaginal_bleeding = 0; 
$fk_anc_convulsions = 0; 
$fk_anc_severe_headache = 0; 
$fk_anc_fever = 0;
$fk_anc_abdominal_pain = 0;
$fk_anc_diff_breath = 0; 
$fk_anc_water_break = 0;
$fk_anc_vaginal_bleed_aph = 0;
$fk_anc_obstructed_labour = 0;
$fk_anc_convulsion = 0; 
$fk_anc_sepsis = 0; 
$fk_anc_severe_headache_delivery = 0;
$fk_anc_consciousness = 0;
$fk_anc_vaginal_bleeding_post = 0;
$fk_anc_convulsion_eclampsia_post = 0;
$fk_anc_high_feaver_post = 0;
$fk_anc_smelling_discharge_post = 0; 
$fk_anc_severe_headache_post = 0; 
$fk_anc_consciousness_post = 0;
$fk_anc_inability_baby = 0; 
$fk_anc_baby_small_baby = 0;
$fk_anc_fast_breathing_baby = 0;
$fk_anc_convulsions_baby = 0;
$fk_anc_drowsy_baby = 0; 
$fk_anc_movement_baby = 0;
$fk_anc_grunting_baby = 0;
$fk_anc_temperature_baby = 0;
$fk_anc_indrawing_baby = 0; 
$fk_anc_hypothermia_baby = 0;
$fk_anc_central_cyanosis_baby = 0;
$fk_anc_umbilicus_baby = 0;
$fk_anc_labour_preg = 0;
$fk_anc_excessive_bld_pre = 0;
$fk_anc_severe_headache_preg = 0;
$fk_anc_convulsion_preg = 0;
$fk_anc_obstructed_preg = 0;
$fk_anc_breath_child = 0;
$fk_anc_placenta_preg = 0;
$fk_anc_suck_baby = 0;
$fk_anc_hot_cold_child = 0; 
$fk_anc_blue_child = 0;
$fk_anc_convulsion_child = 0;
$fk_anc_indrawing_child = 0;
$fk_supliment_post = 0;
$fk_pnc_first_visit_assist = 0;
$fk_post_natal_visit = 0;
$fk_pnc_second_visit_assist = 0;
$remarks = '';
    ...
    { 
        ...
        $fk_headache_id = $pregRecord[0]->fk_headache_id; 
         ...
         $fk_litter_size = $pregRecord[0]->fk_litter_size; 
         $fk_colostrum = $pregRecord[0]->fk_colostrum; 
         $fk_first_milk = $pregRecord[0]->fk_first_milk; 
         $milk_hours = $pregRecord[0]->milk_hours; 
         $milk_day = $pregRecord[0]->milk_day; 
         $fk_facility_delivery = $pregRecord[0]->fk_facility_delivery; 
         $fk_preg_complication = $pregRecord[0]->fk_preg_complication; 
         $fk_delivery_complication = $pregRecord[0]->fk_delivery_complication; 
         $fk_preg_violence = $pregRecord[0]->fk_preg_violence; 

        $fk_anc_first_assist_id = $pregRecord[0]->fk_anc_first_assist_id;
        $fk_anc_second_assist_id = $pregRecord[0]->fk_anc_second_assist_id;
        $fk_anc_third_assist_id = $pregRecord[0]->fk_anc_third_assist_id;
        $fk_anc_fourth_assist_id = $pregRecord[0]->fk_anc_fourth_assist_id;
        $fk_anc_fifth_assist_id =$pregRecord[0]->fk_anc_fifth_assist_id;                 
        $fk_anc_supliment = $pregRecord[0]->fk_anc_supliment;
        $fk_supliment_received_way = $pregRecord[0]->fk_supliment_received_way;
        $fk_how_many_tab = $pregRecord[0]->fk_how_many_tab;
        $totalnumbertab = $pregRecord[0]->totalnumbertab;
        $fk_anc_weight_taken = $pregRecord[0]->fk_anc_weight_taken;
        $fk_anc_blood_pressure = $pregRecord[0]->fk_anc_blood_pressure;
        $fk_anc_urine = $pregRecord[0]->fk_anc_urine;
        $fk_anc_blood = $pregRecord[0]->fk_anc_blood;
        $fk_anc_denger_sign = $pregRecord[0]->fk_anc_denger_sign;
        $fk_anc_nutrition = $pregRecord[0]->fk_anc_nutrition;

        $fk_anc_birth_prepare = $pregRecord[0]->fk_anc_birth_prepare;
        $fk_anc_soap = $pregRecord[0]->fk_anc_soap;
        $fk_anc_delivery_kit = $pregRecord[0]->fk_anc_delivery_kit;
        $fk_anc_care_chix = $pregRecord[0]->fk_anc_care_chix;
        $fk_anc_dried = $pregRecord[0]->fk_anc_dried;
        $fk_anc_bathing = $pregRecord[0]->fk_anc_bathing;
        $fk_anc_breast_feed = $pregRecord[0]->fk_anc_breast_feed;
        $fk_anc_skin_contact = $pregRecord[0]->fk_anc_skin_contact; 
        $fk_anc_enc = $pregRecord[0]->fk_anc_enc;
        $fk_suspecred_infection = $pregRecord[0]->fk_suspecred_infection;
        $fk_baby_antibiotics = $pregRecord[0]->fk_baby_antibiotics;
        $fk_prescribe_antibiotics = $pregRecord[0]->fk_prescribe_antibiotics; 
        $fk_seek_treatment = $pregRecord[0]->fk_seek_treatment;
        $fk_anc_vaginal_bleeding = $pregRecord[0]->fk_anc_vaginal_bleeding;

        $fk_anc_convulsions = $pregRecord[0]->fk_anc_convulsions;
        $fk_anc_severe_headache = $pregRecord[0]->fk_anc_severe_headache;
        $fk_anc_fever = $pregRecord[0]->fk_anc_fever;
        $fk_anc_abdominal_pain = $pregRecord[0]->fk_anc_abdominal_pain;
        $fk_anc_diff_breath = $pregRecord[0]->fk_anc_diff_breath; 
        $fk_anc_water_break = $pregRecord[0]->fk_anc_water_break;
        $fk_anc_vaginal_bleed_aph = $pregRecord[0]->fk_anc_vaginal_bleed_aph;
        $fk_anc_obstructed_labour = $pregRecord[0]->fk_anc_obstructed_labour;
        $fk_anc_convulsion = $pregRecord[0]->fk_anc_convulsion;
        $fk_anc_sepsis = $pregRecord[0]->fk_anc_sepsis;
        $fk_anc_severe_headache_delivery = $pregRecord[0]->fk_anc_severe_headache_delivery;
        $fk_anc_consciousness = $pregRecord[0]->fk_anc_consciousness;
        $fk_anc_vaginal_bleeding_post = $pregRecord[0]->fk_anc_vaginal_bleeding_post;
        $fk_anc_convulsion_eclampsia_post = $pregRecord[0]->fk_anc_convulsion_eclampsia_post;
        $fk_anc_high_feaver_post = $pregRecord[0]->fk_anc_high_feaver_post;
        $fk_anc_smelling_discharge_post = $pregRecord[0]->fk_anc_smelling_discharge_post; 
        $fk_anc_severe_headache_post = $pregRecord[0]->fk_anc_severe_headache_post; 
        $fk_anc_consciousness_post = $pregRecord[0]->fk_anc_consciousness_post;

        $fk_anc_inability_baby = $pregRecord[0]->fk_anc_inability_baby;
        $fk_anc_baby_small_baby = $pregRecord[0]->fk_anc_baby_small_baby;
        $fk_anc_fast_breathing_baby = $pregRecord[0]->fk_anc_fast_breathing_baby;
        $fk_anc_convulsions_baby = $pregRecord[0]->fk_anc_convulsions_baby;
        $fk_anc_drowsy_baby = $pregRecord[0]->fk_anc_drowsy_baby;
        $fk_anc_movement_baby = $pregRecord[0]->fk_anc_movement_baby;
        $fk_anc_grunting_baby = $pregRecord[0]->fk_anc_grunting_baby;
        $fk_anc_temperature_baby = $pregRecord[0]->fk_anc_temperature_baby;
        $fk_anc_indrawing_baby = $pregRecord[0]->fk_anc_indrawing_baby;
        $fk_anc_hypothermia_baby = $pregRecord[0]->fk_anc_hypothermia_baby;
        $fk_anc_central_cyanosis_baby = $pregRecord[0]->fk_anc_central_cyanosis_baby;
        $fk_anc_umbilicus_baby = $pregRecord[0]->fk_anc_umbilicus_baby;
        $fk_anc_labour_preg = $pregRecord[0]->fk_anc_labour_preg;
        $fk_anc_excessive_bld_pre = $pregRecord[0]->fk_anc_excessive_bld_pre;
        $fk_anc_severe_headache_preg = $pregRecord[0]->fk_anc_severe_headache_preg;
        $fk_anc_convulsion_preg = $pregRecord[0]->fk_anc_convulsion_preg;
        $fk_anc_obstructed_preg = $pregRecord[0]->fk_anc_obstructed_preg;
        $fk_anc_breath_child = $pregRecord[0]->fk_anc_breath_child;
        $fk_anc_placenta_preg = $pregRecord[0]->fk_anc_placenta_preg;
        $fk_anc_suck_baby = $pregRecord[0]->fk_anc_suck_baby;
        $fk_anc_hot_cold_child = $pregRecord[0]->fk_anc_hot_cold_child;
        $fk_anc_blue_child = $pregRecord[0]->fk_anc_blue_child;
        $fk_anc_convulsion_child = $pregRecord[0]->fk_anc_convulsion_child;
        $fk_anc_indrawing_child = $pregRecord[0]->fk_anc_indrawing_child;
        $fk_supliment_post = $pregRecord[0]->fk_supliment_post;
        $fk_pnc_first_visit_assist = $pregRecord[0]->fk_pnc_first_visit_assist;
        $fk_post_natal_visit = $pregRecord[0]->fk_post_natal_visit;
        $fk_pnc_second_visit_assist = $pregRecord[0]->fk_pnc_second_visit_assist;
        $remarks = $pregRecord[0]->remarks;
       // $fk_supliment = $pregRecord[0]->fk_supliment;
										...
										<div class="col-md-4">
                                                 ...
                                                 <label for="Active">Did you give colostrum to baby? </label>
                                                  <select class="form-control required" id="fk_colostrum" name="fk_colostrum">
                                                      ...
                                                      if(!empty($yes_no))
                                                      {
                                                          ...
                                                          {
                                                              ?>
                                                              <option <?php if ($fk_colostrum == $yes_no->id) { echo "selected=selected"; } ?> value="<?php echo $yes_no->id ?>"><?php echo $yes_no->code. '-' .$yes_no->name ?></option>
                                                              <?php
                                                          }
                                                      }
                                                      ?>
                                                 ...
                                                 <label for="Active">How long after birth did you first put baby to the breast? </label>
                                                  <select class="form-control required" id="fk_first_milk" name="fk_first_milk">
                                                      ...
                                                      if(!empty($fast_milk_birth))
                                                      {
                                                          ...
                                                          {
                                                              ?>
                                                              <option <?php if ($fk_first_milk == $milk_birth->id) { echo "selected=selected"; } ?> value="<?php echo $milk_birth->id ?>"><?php echo $milk_birth->code. '-' .$milk_birth->name ?></option>
                                                              <?php
                                                          }
                                                      }
                                                      ?>
                                          ...
                                          <div class="col-md-4 hours">
                                              <div class="form-group">
                                                  ...
                                                  <input type="number" class="form-control milk_hours" id="milk_hours" value="<?php echo $milk_hours ?>"  name="milk_hours">
                                              </div>
                                          </div>
                                          ...
                                          <div class="col-md-4 days">
                                              <div class="form-group">
                                                  ...
                                                  <input type="number" class="form-control milk_day" id="milk_day" value="<?php echo $milk_day ?>"  name="milk_day">
                                              </div>
                                          </div>
                                                  ...
                                                  <select class="form-control required" id="fk_facility_delivery" name="fk_facility_delivery">
                                                     <option value="0">Please select</option>
                                                      ...
                                                      if(!empty($facility_delivery))
                                                      {
                                                          ...
                                                          {
                                                              ?>
                                                              <option <?php if ($fk_facility_delivery == $facilitydelivery->id) { echo "selected=selected"; } ?> value="<?php echo $facilitydelivery->id ?>"><?php echo $facilitydelivery->code. '-' .$facilitydelivery->name ?></option>
                                                              <?php
                                                          }
                                                      }
                                                      ?>
                                                 ...
                                                 <label for="Active">Complications during pregnancy? <span style="color:red">*</span></label>
                                                  <select class="form-control required" id="fk_preg_complication" name="fk_preg_complication" required>
                                                      ...
                                                      if(!empty($yes_no_com))
                                                      {
                                                          ...
                                                          {
                                                              ?>
                                                              <option <?php if ($fk_preg_complication == $yesno->id) { echo "selected=selected"; } ?> value="<?php echo $yesno->id ?>"><?php echo $yesno->code. '-' .$yesno->name ?></option>
                                                              <?php
                                                          }
                                                      }
                                                      ?>
                                                 ...
                                                 <label for="Active">Complications during delivery? <span style="color:red">*</span></label>
                                                  <select class="form-control required" id="fk_delivery_complication" name="fk_delivery_complication" required>
                                                      ...
                                                      <?php
                                                          ...
                                                          {
                                                              ?>
                                                              <option <?php if ($fk_delivery_complication == $yesnode->id) { echo "selected=selected"; } ?> value="<?php echo $yesnode->id ?>"><?php echo $yesnode->code. '-' .$yesnode->name ?></option>
                                                              <?php
                                                          }
                                                 ...
                                                 <label for="Active">Did you have any violence during pregnancy? <span style="color:red">*</span></label>
                                                  <select class="form-control required" id="fk_preg_violence" name="fk_preg_violence" required>
                                                      ...
                                                      <?php
                                                          ...
                                                          {
                                                              ?>
                                                              <option <?php if ($fk_preg_violence == $yesnovio->id) { echo "selected=selected"; } ?> value="<?php echo $yesnovio->id ?>"><?php echo $yesnovio->code. '-' .$yesnovio->name ?></option>
                                                              <?php
                                                          }
                                                 ...
                                                 <label for="Active">Litter Size <span style="color:red">*</span></label>
                                                  <select class="form-control required" id="fk_litter_size" name="fk_litter_size" required>
                                                      ...
                                                      if(!empty($litter_size))
                                                      {
                                                          ...
                                                          {
                                                              ?>
                                                              <option <?php if ($fk_litter_size == $litter_size->id) { echo "selected=selected"; } ?> value="<?php echo $litter_size->id ?>"><?php echo $litter_size->code. '-' .$litter_size->name ?></option>
                                                              <?php
                                                          }
                                                      }
                                                      ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control required" id="routineFirstVisitAsist" name="routineFirstVisitAsist">
                                                        ...
                                                        if(!empty($anc_assist_typ))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_first_assist_id == $anc_assist_typ->id) { echo "selected=selected"; } ?> value="<?php echo $anc_assist_typ->id ?>"><?php echo $anc_assist_typ->code. '-' .$anc_assist_typ->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control required" id="routineSecondVisitAsist" name="routineSecondVisitAsist">
                                                        ...
                                                        if(!empty($anc_assist_typ1))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_second_assist_id == $anc_assist_typ1->id) { echo "selected=selected"; } ?> value="<?php echo $anc_assist_typ1->id ?>"><?php echo $anc_assist_typ1->code. '-' .$anc_assist_typ1->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control required" id="routineThirdVisitAsist" name="routineThirdVisitAsist">
                                                        ...
                                                        if(!empty($anc_assist_typ2))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_third_assist_id == $anc_assist_typ2->id) { echo "selected=selected"; } ?> value="<?php echo $anc_assist_typ2->id ?>"><?php echo $anc_assist_typ2->code. '-' .$anc_assist_typ2->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control required" id="routineFourthVisitAsist" name="routineFourthVisitAsist">
                                                        ...
                                                        if(!empty($anc_assist_typ3))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_fourth_assist_id == $anc_assist_typ3->id) { echo "selected=selected"; } ?> value="<?php echo $anc_assist_typ3->id ?>"><?php echo $anc_assist_typ3->code. '-' .$anc_assist_typ3->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control required" id="routineFifthVisitAsist" name="routineFifthVisitAsist">
                                                        ...
                                                        if(!empty($anc_assist_typ4))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_fifth_assist_id == $anc_assist_typ4->id) { echo "selected=selected"; } ?> value="<?php echo $anc_assist_typ4->id ?>"><?php echo $anc_assist_typ4->code. '-' .$anc_assist_typ4->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_supliment" name="fk_supliment" required>
                                                        ...
                                                        if(!empty($onlyYesNo))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_supliment == $onlyyn->id) { echo "selected=selected"; } ?> value="<?php echo $onlyyn->id ?>"><?php echo $onlyyn->code. '-' .$onlyyn->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_supliment_received_way" name="fk_supliment_received_way">
                                                        ...
                                                        if(!empty($ifa_supliment_source))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_supliment_received_way == $isuplimensource->id) { echo "selected=selected"; } ?> value="<?php echo $isuplimensource->id ?>"><?php echo $isuplimensource->code. '-' .$isuplimensource->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_how_many_tab" name="fk_how_many_tab">
                                                        ...
                                                        if(!empty($how_many_tablet))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_how_many_tab == $how_many_tablet->id) { echo "selected=selected"; } ?> value="<?php echo $how_many_tablet->id ?>"><?php echo $how_many_tablet->code. '-' .$how_many_tablet->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                            ...
                                            <div class="col-md-4 numbers">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control totalNumberTablet" placeholder="Total Number" id="totalNumberTablet" value="<?php echo $totalnumbertab ?>" name="totalNumberTablet">
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_weight_taken" name="fk_anc_weight_taken">
                                                        ...
                                                        if(!empty($onlyYesNo))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_weight_taken == $onlyyn->id) { echo "selected=selected"; } ?> value="<?php echo $onlyyn->id ?>"><?php echo $onlyyn->code. '-' .$onlyyn->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_blood_pressure" name="fk_anc_blood_pressure">
                                                        ...
                                                        if(!empty($onlyYesNo))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_blood_pressure == $onlyyn->id) { echo "selected=selected"; } ?> value="<?php echo $onlyyn->id ?>"><?php echo $onlyyn->code. '-' .$onlyyn->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_urine" name="fk_anc_urine">
                                                        ...
                                                        if(!empty($onlyYesNo))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_urine == $onlyyn->id) { echo "selected=selected"; } ?> value="<?php echo $onlyyn->id ?>"><?php echo $onlyyn->code. '-' .$onlyyn->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_blood" name="fk_anc_blood">
                                                        ...
                                                        if(!empty($onlyYesNo))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_blood == $onlyyn->id) { echo "selected=selected"; } ?> value="<?php echo $onlyyn->id ?>"><?php echo $onlyyn->code. '-' .$onlyyn->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_denger_sign" name="fk_anc_denger_sign">
                                                        ...
                                                        if(!empty($onlyYesNo))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_denger_sign == $onlyyn->id) { echo "selected=selected"; } ?> value="<?php echo $onlyyn->id ?>"><?php echo $onlyyn->code. '-' .$onlyyn->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_nutrition" name="fk_anc_nutrition">
                                                        ...
                                                        if(!empty($onlyYesNo))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_nutrition == $onlyyn->id) { echo "selected=selected"; } ?> value="<?php echo $onlyyn->id ?>"><?php echo $onlyyn->code. '-' .$onlyyn->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_birth_prepare" name="fk_anc_birth_prepare">
                                                        ...
                                                        if(!empty($onlyYesNo))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option  <?php if ($fk_anc_birth_prepare == $onlyyn->id) { echo "selected=selected"; } ?> value="<?php echo $onlyyn->id ?>"><?php echo $onlyyn->code. '-' .$onlyyn->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_delivery_kit" name="fk_anc_delivery_kit">
                                                        ...
                                                        if(!empty($onlyYesNo))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_delivery_kit == $onlyyn->id) { echo "selected=selected"; } ?> value="<?php echo $onlyyn->id ?>"><?php echo $onlyyn->code. '-' .$onlyyn->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_soap" name="fk_anc_soap">
                                                        ...
                                                        if(!empty($onlyYesNo))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_soap == $onlyyn->id) { echo "selected=selected"; } ?> value="<?php echo $onlyyn->id ?>"><?php echo $onlyyn->code. '-' .$onlyyn->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_care_chix" name="fk_anc_care_chix">
                                                        ...
                                                        if(!empty($onlyYesNo))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_care_chix == $onlyyn->id) { echo "selected=selected"; } ?> value="<?php echo $onlyyn->id ?>"><?php echo $onlyyn->code. '-' .$onlyyn->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_dried" name="fk_anc_dried">
                                                        ...
                                                        if(!empty($onlyYesNo))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_dried == $onlyyn->id) { echo "selected=selected"; } ?> value="<?php echo $onlyyn->id ?>"><?php echo $onlyyn->code. '-' .$onlyyn->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_bathing" name="fk_anc_bathing">
                                                        ...
                                                        if(!empty($onlyYesNo))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_bathing == $onlyyn->id) { echo "selected=selected"; } ?> value="<?php echo $onlyyn->id ?>"><?php echo $onlyyn->code. '-' .$onlyyn->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_breast_feed" name="fk_anc_breast_feed">
                                                        ...
                                                        if(!empty($onlyYesNo))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_breast_feed == $onlyyn->id) { echo "selected=selected"; } ?> value="<?php echo $onlyyn->id ?>"><?php echo $onlyyn->code. '-' .$onlyyn->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_skin_contact" name="fk_anc_skin_contact">
                                                        ...
                                                        if(!empty($onlyYesNo))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_skin_contact == $onlyyn->id) { echo "selected=selected"; } ?> value="<?php echo $onlyyn->id ?>"><?php echo $onlyyn->code. '-' .$onlyyn->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_enc" name="fk_anc_enc">
                                                        ...
                                                        if(!empty($onlyYesNo))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_enc == $onlyyn->id) { echo "selected=selected"; } ?> value="<?php echo $onlyyn->id ?>"><?php echo $onlyyn->code. '-' .$onlyyn->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_suspecred_infection" name="fk_suspecred_infection">
                                                        ...
                                                        if(!empty($yes_no_not_applicable))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_suspecred_infection == $not_applicable->id) { echo "selected=selected"; } ?> value="<?php echo $not_applicable->id ?>"><?php echo $not_applicable->code. '-' .$not_applicable->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_baby_antibiotics" name="fk_baby_antibiotics">
                                                        ...
                                                        if(!empty($onlyYesNo))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_baby_antibiotics == $onlyyn->id) { echo "selected=selected"; } ?>  value="<?php echo $onlyyn->id ?>"><?php echo $onlyyn->code. '-' .$onlyyn->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control required" id="fk_prescribe_antibiotics" name="fk_prescribe_antibiotics">
                                                        ...
                                                        if(!empty($prescribe_antibiotics))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_prescribe_antibiotics == $antibiotics->id) { echo "selected=selected"; } ?> value="<?php echo $antibiotics->id ?>"><?php echo $antibiotics->code. '-' .$antibiotics->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control required" id="fk_seek_treatment" name="fk_seek_treatment">
                                                        ...
                                                        if(!empty($go_for_treatment))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_seek_treatment == $go_for_treatment->id) { echo "selected=selected"; } ?> value="<?php echo $go_for_treatment->id ?>"><?php echo $go_for_treatment->code. '-' .$go_for_treatment->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_vaginal_bleeding" name="fk_anc_vaginal_bleeding">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_vaginal_bleeding == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_convulsions" name="fk_anc_convulsions">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_convulsions == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_severe_headache" name="fk_anc_severe_headache">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option  <?php if ($fk_anc_severe_headache == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_fever" name="fk_anc_fever">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_fever == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_abdominal_pain" name="fk_anc_abdominal_pain">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_abdominal_pain == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_diff_breath" name="fk_anc_diff_breath">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_diff_breath == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_water_break" name="fk_anc_water_break">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_water_break == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_vaginal_bleed_aph" name="fk_anc_vaginal_bleed_aph">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_vaginal_bleed_aph == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_obstructed_labour" name="fk_anc_obstructed_labour">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_obstructed_labour == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_convulsion" name="fk_anc_convulsion">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_convulsion == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_sepsis" name="fk_anc_sepsis">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_sepsis == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_severe_headache_delivery" name="fk_anc_severe_headache_delivery">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_severe_headache_delivery == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_consciousness" name="fk_anc_consciousness">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_consciousness == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_vaginal_bleeding_post" name="fk_anc_vaginal_bleeding_post">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_vaginal_bleeding_post == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_convulsion_eclampsia_post" name="fk_anc_convulsion_eclampsia_post">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_convulsion_eclampsia_post == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_high_feaver_post" name="fk_anc_high_feaver_post">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_high_feaver_post == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_smelling_discharge_post" name="fk_anc_smelling_discharge_post">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option  <?php if ($fk_anc_smelling_discharge_post == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_severe_headache_post" name="fk_anc_severe_headache_post">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_severe_headache_post == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_consciousness_post" name="fk_anc_consciousness_post">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_consciousness_post == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_inability_baby" name="fk_anc_inability_baby">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_inability_baby == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_baby_small_baby" name="fk_anc_baby_small_baby">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_baby_small_baby == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_fast_breathing_baby" name="fk_anc_fast_breathing_baby">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_fast_breathing_baby == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_convulsions_baby" name="fk_anc_convulsions_baby">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_convulsions_baby == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_drowsy_baby" name="fk_anc_drowsy_baby">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_drowsy_baby == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_movement_baby" name="fk_anc_movement_baby">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_movement_baby == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_grunting_baby" name="fk_anc_grunting_baby">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_grunting_baby == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_indrawing_baby" name="fk_anc_indrawing_baby">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_indrawing_baby == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_temperature_baby" name="fk_anc_temperature_baby">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_temperature_baby == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_hypothermia_baby" name="fk_anc_hypothermia_baby">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_hypothermia_baby == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_central_cyanosis_baby" name="fk_anc_central_cyanosis_baby">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_central_cyanosis_baby == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_umbilicus_baby" name="fk_anc_umbilicus_baby">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_umbilicus_baby == $knvior->id) { echo "selected=selected"; } ?>  value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_labour_preg" name="fk_anc_labour_preg">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_labour_preg == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_excessive_bld_pre" name="fk_anc_excessive_bld_pre">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_excessive_bld_pre == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_severe_headache_preg" name="fk_anc_severe_headache_preg">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_severe_headache_preg == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_obstructed_preg" name="fk_anc_obstructed_preg">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_obstructed_preg == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_convulsion_preg" name="fk_anc_convulsion_preg">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_convulsion_preg == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_placenta_preg" name="fk_anc_placenta_preg">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_placenta_preg == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_breath_child" name="fk_anc_breath_child">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_breath_child == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_suck_baby" name="fk_anc_suck_baby">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_suck_baby == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_hot_cold_child" name="fk_anc_hot_cold_child">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_hot_cold_child == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_blue_child" name="fk_anc_blue_child">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_blue_child == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_convulsion_child" name="fk_anc_convulsion_child">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_convulsion_child == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_anc_indrawing_child" name="fk_anc_indrawing_child">
                                                        ...
                                                        if(!empty($knowledgebehavior))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_anc_indrawing_child == $knvior->id) { echo "selected=selected"; } ?> value="<?php echo $knvior->id ?>"><?php echo $knvior->code. '-' .$knvior->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_supliment_post" name="fk_supliment_post">
                                                        ...
                                                        if(!empty($onlyYesNo))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_supliment_post == $onlyyn->id) { echo "selected=selected"; } ?> value="<?php echo $onlyyn->id ?>"><?php echo $onlyyn->code. '-' .$onlyyn->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="fk_post_natal_visit" name="fk_post_natal_visit">
                                                        ...
                                                        if(!empty($onlyYesNo))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_post_natal_visit == $onlyyn->id) { echo "selected=selected"; } ?> value="<?php echo $onlyyn->id ?>"><?php echo $onlyyn->code. '-' .$onlyyn->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control required" id="pncFirstVisitAsist" name="pncFirstVisitAsist">
                                                        ...
                                                        if(!empty($pnc_assist_typ))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_pnc_first_visit_assist == $pnc_assist_typ->id) { echo "selected=selected"; } ?> value="<?php echo $pnc_assist_typ->id ?>"><?php echo $pnc_assist_typ->code. '-' .$pnc_assist_typ->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control required" id="pncSecondVisitAsist" name="pncSecondVisitAsist">
                                                        ...
                                                        if(!empty($pnc_assist_typ1))
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option <?php if ($fk_pnc_second_visit_assist == $pnc_assist_typ1->id) { echo "selected=selected"; } ?> value="<?php echo $pnc_assist_typ1->id ?>"><?php echo $pnc_assist_typ1->code. '-' .$pnc_assist_typ1->name ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
