        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form action="<?php echo base_url() . 'Family_planning_report/update_family_planning?baseID=' . $baseID ?>" id="myForm" role="form" data-toggle="validator" method="post" accept-charset="utf-8">
                                        ...
                                        <fieldset class="scheduler-border">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="checkbox">
                                                        <label><input value="<?php if ($familyPlanningRecord->available_govt_hospital > 0) echo $familyPlanningRecord->available_govt_hospital;else echo 1;  ?>" name="available_govt_hospital" type="checkbox">সরকারি হাসপাতাল / মেডিকেল কলেজ হাসপাতাল</label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label><input value="<?php if ($familyPlanningRecord->available_central_dist_hospital > 0) echo $familyPlanningRecord->available_central_dist_hospital;else echo 2; ?>" name="available_central_dist_hospital" type="checkbox">জেলা সদর হাসপাতাল</label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label><input value="<?php if ($familyPlanningRecord->available_matri_sonod > 0) echo $familyPlanningRecord->available_matri_sonod; else echo 3; ?>" name="available_matri_sonod" type="checkbox">মাতৃসদন/মাতৃমঙ্গল/মেটারনিটি</label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label><input value="<?php if ($familyPlanningRecord->available_ngo_facility > 0) echo $familyPlanningRecord->available_ngo_facility;else echo 4; ?>" name="available_ngo_facility" type="checkbox">NGO facility supported by UPHCSDP</label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label><input value="<?php if ($familyPlanningRecord->available_upazilla_sasthokendro > 0) echo $familyPlanningRecord->available_upazilla_sasthokendro;else echo 5; ?>" name="available_upazilla_sasthokendro" type="checkbox">উপজেলা স্ব্যাস্থকেন্দ্র</label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label><input value="<?php if ($familyPlanningRecord->available_union_sastho_poribar_kollan_kendro > 0) echo $familyPlanningRecord->available_union_sastho_poribar_kollan_kendro;else echo 6; ?>" name="available_union_sastho_poribar_kollan_kendro" type="checkbox">ইউনিয়ন স্ব্যাস্থ ও পরিবারকল্যান কেন্দ্র</label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label><input value="<?php if ($familyPlanningRecord->available_satellite_clinic > 0) echo $familyPlanningRecord->available_satellite_clinic;else echo 7; ?>" name="available_satellite_clinic" type="checkbox">স্যাটেলাইটক্লিনিক/ইপিআই প্রোগ্রাম</label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label><input value="<?php if ($familyPlanningRecord->available_community_clinic > 0) echo $familyPlanningRecord->available_community_clinic;else echo 8; ?>" name="available_community_clinic" type="checkbox">কমিউনিটি ক্লিনিক</label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label><input value="<?php if ($familyPlanningRecord->available_ngo_and_satellite_clinic > 0) echo $familyPlanningRecord->available_ngo_and_satellite_clinic;else echo 9; ?>" name="available_ngo_and_satellite_clinic" type="checkbox">এনজিও স্যাটেলাইট ক্লিনিক</label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label><input value="<?php if ($familyPlanningRecord->available_ngo_and_static_clinic > 0) echo $familyPlanningRecord->available_ngo_and_static_clinic;else echo 10; ?>" name="available_ngo_and_static_clinic" type="checkbox">এনজিও স্ট্যাটিক ক্লিনিক</label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label><input value="<?php if ($familyPlanningRecord->available_private_hospital > 0) echo $familyPlanningRecord->available_private_hospital;else echo 11; ?>" name="available_private_hospital" type="checkbox">প্রাইভেট হাসপাতাল/ক্লিনিক</label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label><input value="<?php if ($familyPlanningRecord->available_mbbs_doctor_chamber > 0) echo $familyPlanningRecord->available_mbbs_doctor_chamber;else echo 12; ?>" name="available_mbbs_doctor_chamber" type="checkbox">এমবিবিএস ডাক্তার চেম্বার</label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label><input value="<?php if ($familyPlanningRecord->available_doctor_without_degrees > 0) echo $familyPlanningRecord->available_doctor_without_degrees;else echo 13; ?>" name="available_doctor_without_degrees" type="checkbox">ডিগ্রীধারি ডাক্তারের চেম্বারেনা</label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label><input value="<?php if ($familyPlanningRecord->available_pharmacy > 0) echo $familyPlanningRecord->available_pharmacy;else echo 14; ?>" name="available_pharmacy" type="checkbox">ফার্মেসী</label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label><input value="<?php if ($familyPlanningRecord->available_other > 0) echo $familyPlanningRecord->available_other;else echo 15; ?>" name="available_other" id="available_other" type="checkbox">অন্যান্য (উল্লেখ করুন)</label>
                                                    </div>
                                                </div>
                                            </div>
