        ...
        <div class="row">
            ...
            <div class="col-xs-6 text-right">
                <div class="form-group margin5pxBot">
                    <a class="btn btn-primary" href="<?php echo base_url() . 'member_pregnancy?baseID=' . $baseID ?>"> Go Back</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form action="<?php echo base_url() . $controller . '/' . $actionMethod . '?baseID=' . $baseID ?>" method="post" id="editUser" role="form">
                        <input type="hidden" name="member_pregnancy_id" value="<?php echo $member_pregnancy_id; ?>">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group col-md-4">
                                        <label><b>1.1</b> মায়ের নাম:</label>
                                        <input name="Q1_1_N1" value="<?php echo $userRecords->member_name ?>" type="text" class="form-control">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>Member ID:</label>
                                        <input name="Q1_1_CID" value="<?php echo $userRecords->member_code ?>" type="text" class="form-control">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>LPODT:</label>
                                        <input name="Q1_1_LPODT" type="text" class="form-control">
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <select id="Q1_2" name="Q1_2" class="form-control">
                                            ...
                                            <?php foreach ($VA_Yes_No_Reluctant_Unknown as $VA_Yes_No_Reluctant_Unknown_single) { ?>
                                                <option value="<?php echo $VA_Yes_No_Reluctant_Unknown_single->id; ?>"><?php echo $VA_Yes_No_Reluctant_Unknown_single->name; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <select id="Q1_3" class="form-control" name="Q1_3">
                                            ...
                                            <?php foreach ($VA_Mother_Death_When as $VA_Mother_Death_When_single) { ?>
                                                <option value="<?php echo $VA_Mother_Death_When_single->id; ?>"><?php echo $VA_Mother_Death_When_single->name; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <input style="display:none;" type="number" id="Q1_4_off" name="Q1_4_DAY_OR_MONTH" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group col-md-6">
                                        <select id="Q1_12" class="form-control" name="Q1_12">
                                            ...
                                            <?php foreach ($VA_Baby_Weight as $VA_Baby_Weight_single) { ?>
                                                <option value="<?php echo $VA_Baby_Weight_single->id; ?>"><?php echo $VA_Baby_Weight_single->name; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <input style="display:none;" type="number" id="Q1_13_off" name="Q1_13_kg" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group col-md-6">
                                    ...
                                    <div style="display:none;" class="form-group col-md-6 Q1_15_part">
                                        ...
                                        <br/>
                                        <input style="display:none;" id="Q1_15_off" type="text" name="Q1_15_OTHER" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                        ...
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <br/>
                                                    <input style="display:none;" id="Q2_G_off" type="text" name="Q2_G_OTHER" class="form-control">
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                        ...
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tr><td style="text-align: left;">&nbsp;অন্যান্য রোগ (উল্লেখ করুন)</td>
                                                <td>
                                                    ...
                                                    <br/>
                                                    <input style="display:none;" id="Q2_1_23_off" type="text" name="Q2_1_23_OTHER" class="form-control">
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 Q2_3_part">
                                        <label><b>2.3</b>&nbsp;কত ডোজ টিটি টিকা নিয়েছিলেন?</label>
                                        <input id="Q2_3" name="Q2_3" type="text" class="form-control" placeholder="ডোজ">
                                    </div>
                                    <div class="form-group col-md-12">
                                    ...
                                    <div class="form-group col-md-2"><input name="Q2_5_alive" type="text" class="form-control" placeholder="জীবিত জন্ম"></div>
                                    <div class="form-group col-md-2"><input name="Q2_5_dead" type="text" class="form-control" placeholder="মৃত জন্ম"></div>
                                    <div class="form-group col-md-2"><input name="Q2_5_mr" type="text" class="form-control" placeholder="গর্ভপাত/এমআর"></div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        <input name="Q2_6_DATE" class="datepicker form-control">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label><b>2.7</b>&nbsp;তিনি (মা) কতমাস যাবৎ গর্ভবতী ছিলেন?</label>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <input name="Q2_7" type="text" class="form-control" placeholder="মাস">
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        <select id="Q2_8" class="form-control" name="Q2_8">
                                            ...
                                            <?php foreach ($VA_Pregnancy_Ending_Time as $VA_Pregnancy_Ending_Time_single) { ?>
                                                <option value="<?php echo $VA_Pregnancy_Ending_Time_single->id; ?>"><?php echo $VA_Pregnancy_Ending_Time_single->name; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <input style="display:none;" type="number" id="Q2_10_off" name="Q2_10_DAY_OR_HOUR" class="form-control">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label><b>2.11</b>&nbsp;প্রসব ব্যথা কত ঘন্টা ছিল?</label>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <input name="Q2_11" type="text" class="form-control" placeholder="ঘন্টা">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="display:none;" id="Q2_12_off" type="text" name="Q2_12_OTHER" class="form-control">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label><b>2.13</b>&nbsp;স্বাস্থ্য সেবা প্রতিষ্ঠানে প্রসব হলে তার নাম ও ঠিকানা লিখুন</label>
                                        <textarea name="Q2_13" class="form-control"></textarea>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label><b>2.14</b>&nbsp;ডেলিভারী করাতে কে প্রধান ভূমিকায় ছিলেন? (নাম ও ঠিকানা)</label>
                                        <textarea name="Q2_14" class="form-control"></textarea>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="Q2_14_comment" style="resize: none;" class="form-control"></textarea>
                                    </div>

                                    <div class="col-md-6">
                                        <label>Date of editing questionnaire </label>
                                        <input name="Q2_14_DOE" type="text" class="datepicker form-control">
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <select name="Q2_14_SUP_CODE" class="form-control">
                                            ...
                                            <?php foreach ($VA_Supervisor_List as $VA_Supervisor_List_single) { ?>
                                                <option value="<?php echo $VA_Supervisor_List_single->id; ?>"><?php echo $VA_Supervisor_List_single->name; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
