        ...
        <div class="row">
            ...
            <div class="col-xs-6 text-right">
                <div class="form-group margin5pxBot">
                    <a class="btn btn-primary" href="<?php echo base_url() . $controller . '/internal_out?baseID=' . $baseID ?>"><?php echo $shortName ?> List</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo base_url() . $controller . '/' . $actionMethod . '?baseID=' . $baseID ?>" method="post" id="editUser" role="form">
                        <input type="hidden" name="migrationID" value="<?php echo $internal_out_info->id; ?>">
                        <input type="hidden" name="member_master_id" value="<?php echo $internal_out_info->member_master_id; ?>">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-3 form-group">
                                    <b>Household Code:</b> <?php echo $internal_out_info->household_code; ?>
                                </div>
                                <div class="col-md-3 form-group">
                                    <b>Round No:</b> <?php echo $internal_out_info->round_master_id; ?>
                                </div>
                                <div class="col-md-3 form-group">
                                    <b>Member Code:</b> <?php echo $internal_out_info->member_code; ?>
                                </div>
                                <div class="col-md-3 form-group">
                                    <b>Member Name:</b> <?php echo $internal_out_info->member_name; ?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3 form-group">
                                    <b>Member sex :</b> <?php echo $internal_out_info->gender_code . '-' . $internal_out_info->gender_name; ?>
                                </div>
                            </div>
                            <fieldset class="scheduler-border">
                                        ...
                                        <select class="form-control" id="fk_movement_type" name="fk_movement_type" disabled>
                                            ...
                                            if (!empty($memberexittyp)) {
                                                foreach ($memberexittyp as $memberexittyp) {
                                                    ?>
                                                    <option <?php
                                                    if ($internal_out_info->fk_movement_type == $memberexittyp->id) {
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php
                                        $movement_date=NULL;
                                        if ($internal_out_info->movement_date != "") {
                                            $partsRequire = explode('-', $internal_out_info->movement_date);
                                ...
                                <div class="col-md-4 internal">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control fk_internal_cause" id="fk_internal_cause" required name="fk_internal_cause">
                                            <option value="">Please Select</option>
                                            <?php
                                            if (!empty($internal_movement_cause)) {
                                                foreach ($internal_movement_cause as $internal_movement_cause) {
                                                    ?>
                                                    <option <?php
                                                    if ($internal_out_info->fk_internal_cause == $internal_movement_cause->id) {
                                                        echo "selected=selected";
                                                    }
                                        ...
                                        <select class="form-control slumID" id="slumID" required name="slumID">
                                            ...
                                            if (!empty($slumlist)) {
                                                foreach ($slumlist as $slum) {
                                                    ?>
                                                    <option <?php
                                                    if ($internal_out_info->slumIDTo == $slum->id) {
                                                        echo "selected=selected";
                                                    }
                                ...
                                <div class="col-md-4 internal">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control slumAreaID" id="slumAreaID" required name="slumAreaID">
                                ...
                                <div class="col-md-4 internal">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control househodID" required id="househodID2" name="househodID">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea  class="form-control" name="remarks"><?php echo $internal_out_info->remarks; ?></textarea>
...
<script type="text/javascript">
    $(document).ready(function () {
            ...
            if (selslumID != '')
            {
                $.ajax({
                    ...
                    success: function (data)
                    {
                        $('#slumAreaID').html('');
                        $('#slumAreaID').html(data);
                        $('#slumAreaID').val('<?php echo $internal_out_info->slumAreaIDTo; ?>').trigger('change');
                    }
                });
            ...
            if (slumAreaID != '')
            {
                $.ajax({
                    ...
                    success: function (data)
                    {
                        ...
                        $('#househodID2').val('<?php echo $internal_out_info->household_master_id_move_to; ?>').trigger('change');
        ...
        var selslumAreaID = <?php echo $internal_out_info->slumAreaIDTo; ?>;
        if (selslumAreaID > 0)
        {
