                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="" style="color: #00799E;text-align: center;font-weight: bold;">
                            Verbal Autopsy for Stillbirth in Matlab HDSS area - 2019
                        </h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <?php
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div <?php if ($userInfo->Q1_14 != 1491) echo " style='display:none;'"; ?> class="form-group col-md-6 Q1_15_part">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group col-md-6">
                                        <b>2.0</b>&nbsp;
                                        <table style="text-align: center;border-collapse: collapse;border-color: lightgray;" border="1">
                                            <tr>
                                    ...
                                    <div <?php if ($userInfo->Q2_2 != 1491) echo " style='display:none;'"; ?> class="form-group col-md-6 Q2_3_part">
                                ...
                                <div class="col-md-12">
                                    ...
                                    if ($userInfo->Q2_6_DATE == "") {
                                        $userInfo->Q2_6_DATE = "0000-00-00";
                                    }
                                    $partsRequire = explode('-', $userInfo->Q2_6_DATE);
                                    $Q2_6_DATE = $partsRequire[2] . '/' . $partsRequire[1] . '/' . $partsRequire[0];
                                    ?>
                                    <div class="form-group col-md-6">
                                        <input value="<?php if ($userInfo->Q2_6_DATE != "0000-00-00") echo $Q2_6_DATE; ?>" name="Q2_6_DATE" class="datepicker form-control">
                                    </div>
                                    <div class="form-group col-md-6">
...
?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input value="<?php if ($userInfo->Q2_14_DOE != "0000-00-00") echo $Q2_14_DOE; ?>" name="Q2_14_DOE" type="text" class="datepicker form-control">
                                    </div>
                                    <div class="col-md-6">
...
<?php foreach ($VA_Supervisor_List as $VA_Supervisor_List_single) { ?>
    ...
    <script>
                                            ...
                                            function showHideQuestion(id) {
                                                var y = $("#" + id).children(":selected").attr("id");
                                                var para = y.split("@");
                                                var dp_classList_on = para[1].split("+");
                                                var dp_classList_off = para[2].split("+");

                                                var IDlist_on = para[3].split("+");
                                                var IDlist_off = para[4].split("+");

                                                alert("IDlist_on= " + IDlist_on);
                                                alert("IDlist_off= " + IDlist_off);

                                                dp_classList_off.forEach(hideClass);
                                                dp_classList_on.forEach(showClass);

                                                IDlist_off.forEach(DisableRequiredFields);
                                                IDlist_on.forEach(EnableRequiredFields);
