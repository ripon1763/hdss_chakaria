...
if(!empty($userInfo))
{
    foreach ($userInfo as $uf)
    {
        ...
        $contactNoOne = $uf->contactNoOne;
        $contactNoTwo = $uf->contactNoTwo;
        ...
        $fk_father_id = $uf->fk_father_id;
        $fk_mother_id = $uf->fk_mother_id;
        $fk_spouse_id = $uf->fk_spouse_id;
       ...
       // $spouse_code = $uf->spouse_code;
        ...
        $main_occupation_oth =$uf->main_occupation_oth;
                               ...
                               <div class="col-md-3">
                                        ...
                                        <select class="form-control" id="fatherCode" name="fatherCode">
                                           ...
                                           <?php
                                            if(!empty($fatherList))
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <option <?php  if ($father->id == $fk_father_id) { echo "selected=selected";} ?>  value="<?php echo $father->id ?>"><?php echo $father->member_code. '-' .$father->member_name ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
                                        ...
                                        <select class="form-control" id="motherCode" name="motherCode">
                                           ...
                                           <?php
                                            if(!empty($motherList))
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <option <?php  if ($mother->id == $fk_mother_id) { echo "selected=selected";} ?> value="<?php echo $mother->id ?>"><?php echo $mother->member_code. '-' .$mother->member_name ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
                                        ...
                                        <select class="form-control" id="spouseCode" name="spouseCode">
                                           ...
                                           <?php
                                            if(!empty($spouseList))
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <option <?php  if ($spouse->id == $fk_spouse_id) { echo "selected=selected";} ?> value="<?php echo $spouse->id ?>"><?php echo $spouse->member_code. '-' .$spouse->member_name ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php echo $national_id ?>"  id="nationalID"  name="nationalID" maxlength="255">
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required yearOfEdu" id="yearOfEdu" name="yearOfEdu">
                                            ...
                                            if(!empty($education_year))
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <option  <?php  if ($education_year->id == $year_of_education) { echo "selected=selected";} ?> value="<?php echo $education_year->id ?>"><?php echo $education_year->code. '-' .$education_year->name ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
                              ...
                              <!--  <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control afterManyYear" id="afterManyYear" name="afterManyYear">
                                            ...
                                            if(!empty($child_after_year))
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <option <?php  if ($after_year->id == $afterYear) { echo "selected=selected";} ?> value="<?php echo $after_year->id ?>"><?php echo $after_year->code. '-' .$after_year->name ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
								...
								<div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="contactNoOne" value="<?php echo $contactNoOne ?>"  name="contactNoOne" minlength="11" maxlength="11">
                                    </div>
                                </div>
								<div class="col-md-3">
                                    <div class="form-group">
                                        <label for="Item Name">Contact No(Two) </label>
                                        <input type="text" class="form-control" id="contactNoTwo" value="<?php echo $contactNoTwo ?>"  name="contactNoTwo" minlength="11" maxlength="11">
                                    </div>
                                </div>
