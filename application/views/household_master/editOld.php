                               ...
                               <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="bariwallaName" placeholder="Name of Bariwalla"  name="bariwallaName" value="<?php echo $bariwalla_name ?>" maxlength="255" required="required">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="bariNumber"  placeholder="Bari Number" name="bariNumber" value="<?php echo $barino ?>" minlength="5" maxlength="10" size="10" required="required">
                                    </div>
                                </div>
                                 ...
                                 <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $household_head_name ?>" placeholder="Name of Household head" class="form-control required" id="headName"  name="headName" maxlength="255" required="required">
                                    </div>
                                </div>
                                 ...
                                 <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="livingYear"  placeholder="Living Year"  name="livingYear" value="<?php echo $longlivy ?>" minlength="1" maxlength="2" size="10" required="required">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="Item Name">How long living here (Month)</label>
                                        <input type="text" class="form-control required" id="livingMonth" placeholder="Living Month"  name="livingMonth" value="<?php echo $longlivm ?>" minlength="1" maxlength="2" size="10" required="required">
                                    </div>
                                </div>
								...
								<div class="col-md-3 migin">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="leftSlum"  name="leftSlum" minlength="1" value="<?php echo $leftpad ?>" maxlength="2" size="10" >
                                    </div>
                                </div>
								
                                <div class="col-md-3 migration" >
                                    <div class="form-group">
                                        <label for="Active"><span class="mig">Migration cause</span> <span class="intn">Internal cause</span> reason</label>
                                        <select class="form-control required migrationReason" id="migrationReason" name="migrationReason">
                                            ...
                                            if(!empty($migrationReason))
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <option <?php if ($mig->id == $fk_migration_reason) { echo "selected=selected";} ?>   value="<?php echo $mig->id ?>"><?php echo $mig->code. '-' .$mig->name ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
                                        ...
                                        <select class="form-control required" id="countryID" name="countryID">
                                           ...
                                           <?php
                                            if(!empty($country))
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <option <?php if ($country->id == $fk_country_id_from) { echo "selected=selected";} ?> value="<?php echo $country->id ?>"><?php echo $country->code. '-' .$country->name ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="migDistrictID" name="migDistrictID" >
                                            ...
                                            if(!empty($district2))
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <option <?php if ($dist->id == $fk_district_id_from) { echo "selected=selected";} ?> value="<?php echo $dist->id ?>"><?php echo $dist->code. '-' .$dist->name ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
                                ...
                                <div class="col-md-12 migrationOth">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $migration_reason_oth ?>"  class="form-control migreasonOth" id="migreasonOth"  name="migreasonOth" maxlength="255">
                                    </div>
                                </div>

                                 <div class="col-md-3 internal">
                                    <div class="form-group">
                                        <label for="Item Name">Slum Name From </label>
                                        
                                        <select class="form-control required" id="slumIDFrom" name="slumIDFrom">
                                           <option value="">--- Select Name Slum ---</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="contactNumber" value="<?php echo $contact_number ?>"  name="contactNumber" maxlength="255" required="required">
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="contactSource" name="contactSource" required>
                                            ...
                                            if(!empty($hhcontacttyp))
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <option <?php if ($contact->id == $fk_contract_type) { echo "selected=selected";} ?>  value="<?php echo $contact->id ?>"><?php echo $contact->code. '-' .$contact->name ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
