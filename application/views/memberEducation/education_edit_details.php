											...
											<div class="form-group">
											 ...
											 <select class="form-control yearOfEdu" id="yearOfEdu" name="yearOfEdu">
												...
												if(!empty($education_year))
												{
													...
													{
														?>
														<option <?php if ($year_of_education == $education_year->id) { echo "selected=selected";} ?> value="<?php echo $education_year->id ?>"><?php echo $education_year->code. '-' .$education_year->name ?></option>
														<?php
													}
												}
												?>
