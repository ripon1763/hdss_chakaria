...
<?php $baseID = $this->input->get('baseID',TRUE); ?>
 <?php 
    ...
    ?>
                    ...
                    <form action="<?php echo base_url().'Baseline_census/addNewAsset?baseID='.$baseID ?>" id="myForm" role="form" data-toggle="validator" method="post" accept-charset="utf-8">
                                                    ...
                                                    <label for="email">এই জমির মালিক কে? <span style="color:red">*</span></label>
                                                     ...
                                                     <select name="fk_owner_land" id="fk_owner_land" class="form-control" required style="">
                                                        ...
                                                        <?php if (!empty($land_owner))
                                                        {
                                                            ...
                                                            {
                                                            ?>
                                                               <option  value="<?php echo $land->id  ?>"><?php echo $land->code.'-'.$land->name  ?></option>
                                                        ...
                                                        <?php if (!empty($house_owner))
                                                            {
                                                                ...
                                                                {
                                                                ?>
                                                                   <option  value="<?php echo $house->id  ?>"><?php echo $house->code.'-'.$house->name  ?></option>
                                                         ...
                                                         <?php if (!empty($assetYesNo))
                                                            {
                                                                ...
                                                                {
                                                                ?>
                                                                   <option  value="<?php echo $chair->id  ?>"><?php echo $chair->code.'-'.$chair->name  ?></option>
                                                         ...
                                                         <?php if (!empty($assetYesNo))
                                                            {
                                                                ...
                                                                {
                                                                ?>
                                                                   <option  value="<?php echo $table->id  ?>"><?php echo $table->code.'-'.$table->name  ?></option>
                                                         ...
                                                         <?php if (!empty($assetYesNo))
                                                            {
                                                                ...
                                                                {
                                                                ?>
                                                                   <option  value="<?php echo $khat->id  ?>"><?php echo $khat->code.'-'.$khat->name  ?></option>
                                                          ...
                                                          <?php if (!empty($assetYesNo))
                                                            {
                                                                ...
                                                                {
                                                                ?>
                                                                   <option  value="<?php echo $chowki->id  ?>"><?php echo $chowki->code.'-'.$chowki->name  ?></option>
                                                          ...
                                                          <?php if (!empty($assetYesNo))
                                                            {
                                                                ...
                                                                {
                                                                ?>
                                                                   <option  value="<?php echo $almirah->id  ?>"><?php echo $almirah->code.'-'.$almirah->name  ?></option>
                                                         ...
                                                         <?php if (!empty($assetYesNo))
                                                            {
                                                                ...
                                                                {
                                                                ?>
                                                                   <option  value="<?php echo $sofa->id  ?>"><?php echo $sofa->code.'-'.$sofa->name  ?></option>
                                                          ...
                                                          <?php if (!empty($assetYesNo))
                                                            {
                                                                ...
                                                                {
                                                                ?>
                                                                   <option  value="<?php echo $radio->id  ?>"><?php echo $radio->code.'-'.$radio->name  ?></option>
                                                          ...
                                                          <?php if (!empty($assetYesNo))
                                                            {
                                                                ...
                                                                {
                                                                ?>
                                                                   <option  value="<?php echo $tv->id  ?>"><?php echo $tv->code.'-'.$tv->name  ?></option>
                                                          ...
                                                          <?php if (!empty($assetYesNo))
                                                            {
                                                                ...
                                                                {
                                                                ?>
                                                                   <option  value="<?php echo $freeze->id  ?>"><?php echo $freeze->code.'-'.$freeze->name  ?></option>
                                                         ...
                                                         <?php if (!empty($assetYesNo))
                                                            {
                                                                ...
                                                                {
                                                                ?>
                                                                   <option  value="<?php echo $mobile->id  ?>"><?php echo $mobile->code.'-'.$mobile->name  ?></option>
                                                         ...
                                                         <?php if (!empty($assetYesNo))
                                                            {
                                                                ...
                                                                {
                                                                ?>
                                                                   <option  value="<?php echo $fan->id  ?>"><?php echo $fan->code.'-'.$fan->name  ?></option>
                                                          ...
                                                          <?php if (!empty($assetYesNo))
                                                            {
                                                                ...
                                                                {
                                                                ?>
                                                                   <option  value="<?php echo $watch->id  ?>"><?php echo $watch->code.'-'.$watch->name  ?></option>
                                                         ...
                                                         <?php if (!empty($assetYesNo))
                                                            {
                                                                ...
                                                                {
                                                                ?>
                                                                   <option  value="<?php echo $rickshow->id  ?>"><?php echo $rickshow->code.'-'.$rickshow->name  ?></option>
                                                          ...
                                                          <?php if (!empty($assetYesNo))
                                                            {
                                                                ...
                                                                {
                                                                ?>
                                                                   <option  value="<?php echo $computer->id  ?>"><?php echo $computer->code.'-'.$computer->name  ?></option>
                                                         ...
                                                         <?php if (!empty($assetYesNo))
                                                            {
                                                                ...
                                                                {
                                                                ?>
                                                                   <option  value="<?php echo $machine->id  ?>"><?php echo $machine->code.'-'.$machine->name  ?></option>
                                                         ...
                                                         <?php if (!empty($assetYesNo))
                                                            {
                                                                ...
                                                                {
                                                                ?>
                                                                   <option  value="<?php echo $cycle->id  ?>"><?php echo $cycle->code.'-'.$cycle->name  ?></option>
                                                          ...
                                                          <?php if (!empty($assetYesNo))
                                                            {
                                                                ...
                                                                {
                                                                ?>
                                                                   <option  value="<?php echo $motor_cycle->id  ?>"><?php echo $motor_cycle->code.'-'.$motor_cycle->name  ?></option>
