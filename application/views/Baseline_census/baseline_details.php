...
<form action="<?php echo base_url() . 'Baseline_census/addNewBaseLineCensus?baseID=' . $baseID ?>" id="myForm" role="form" data-toggle="validator" method="post" accept-charset="utf-8">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || event.charCode === 32" type="text" name="upazilla_name" id="upazilla_name" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="division_id" id="division_id" class="form-control" required>
                                ...
                                if (!empty($divisions)) {
                                    foreach ($divisions as $division) {
                                        ?>
                                        <option <?php if ($division->name == 'Others') echo " style='display:none'"; ?>  value="<?php echo $division->id ?>"><?php echo $division->code.'-'.$division->name; ?></option>
                ...
                <fieldset class="scheduler-border">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="checkbox">
                                    <label><input type="checkbox" id="looking_for_work" name="looking_for_work" value="1">কাজের খোঁজে (1)</label>
                                </div>
                                <div class="checkbox">
                                    <label><input type="checkbox" id="for_earning_more_money" name="for_earning_more_money" value="2">বেশি টাকা উপার্জনের জন্য (2)</label>
                                </div>
                                <div class="checkbox">
                                    <label><input type="checkbox" id="river_erosion" name="river_erosion" value="3">নদী ভাঙ্গনের জন্য (3)</label>
                                </div>
                                <div class="checkbox">
                                    <label><input type="checkbox" id="for_family" name="for_family" value="4">পরিবারের জন্য (4)</label>
                                </div>
                                <div class="checkbox">
                                    <label><input type="checkbox" id="for_children_education" name="for_children_education" value="5">বাচ্চার লেখাপড়ার জন্য (5)</label>
                                </div>
                                <div class="checkbox">
                                    <label><input type="checkbox" id="for_own_education" name="for_own_education" value="6">নিজের শিক্ষার জন্য (06)</label>
                                </div>
                                <div class="checkbox">
                                    <label><input type="checkbox" id="for_marriage" name="for_marriage" value="7">বিয়ের জন্য (07)</label>
                                </div>
                                <div class="checkbox">
                                    <label><input type="checkbox" id="na_as_birth_here" name="na_as_birth_here" value="88">প্রযোজ্য নয় (জন্ম এখানে) (88)</label>
                                </div>
                                <div class="checkbox">
                                    <label><input type="checkbox" id="coming_reason_other" name="coming_reason_other" value="99">অন্যান্য (99)</label>
                                </div>
                        ...
                        <div class="col-md-4 coming_reason_other_part">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="coming_reason_other_specify" name="coming_reason_other_specify">
                            </div>
                        </div>
                    </div>
                </fieldset>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 pregnancy_status_since_when_part">
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off" class="date_format form-control" id="pregnancy_status_since_when" name="pregnancy_status_since_when">
                        </div>
                    </div>
                </div>
            </fieldset> -->
                ...
                <div class="row">
                            ...
                            <select name="roof" id="roof" class="form-control" required>
                                ...
                                if (!empty($roof_build_with)) {
                                    foreach ($roof_build_with as $roof_build_with_single) {
                                        ?>
                                        <option  value="<?php echo $roof_build_with_single->id ?>"><?php echo $roof_build_with_single->code.'-'.$roof_build_with_single->name ?></option>
                    ...
                    <div class="col-md-6 roof_other_part">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="roof_other" name="roof_other">
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6 wall_other_part">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="wall_other" name="wall_other">
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <select name="floor" id="floor" class="form-control" required >
                                ...
                                if (!empty($floor_build_with)) {
                                    foreach ($floor_build_with as $floor_build_with_single) {
                                        ?>
                                        <option  value="<?php echo $floor_build_with_single->id ?>"><?php echo $floor_build_with_single->code.'-'.$floor_build_with_single->name ?></option>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="room" type="text" id="room" class="form-control" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="allowDecimalOrInteger form-control" id="room1l" name="room1l" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="room1b">প্রস্থ:<span style="color:red;">*</span></label>
                                    <input type="text" class="allowDecimalOrInteger form-control" id="room1b" name="room1b" required>
                                </div>
                            </div>
                        </div>
                    </fieldset>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="allowDecimalOrInteger form-control" id="room2l" name="room2l">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="room2b">প্রস্থ:</label>
                                    <input type="text" class="allowDecimalOrInteger form-control" id="room2b" name="room2b">
                                </div>
                            </div>
                        </div>
                    </fieldset>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="allowDecimalOrInteger form-control" id="room3l" name="room3l">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="room3b">প্রস্থ:</label>
                                    <input type="text" class="allowDecimalOrInteger form-control" id="room3b" name="room3b">
                                </div>
                            </div>
                        </div>
                    </fieldset>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="Q42A" id="Q42A" class="allowDecimalOrInteger form-control" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="Q42B" id="Q42B" class="allowDecimalOrInteger form-control" required>
                            ...
                            <select name="water" id="water" class="form-control" required >
                                ...
                                if (!empty($water_source)) {
                                    foreach ($water_source as $water_source_single) {
                                        ?>
                                        <option  value="<?php echo $water_source_single->id; ?>"><?php echo $water_source_single->code.'-'.$water_source_single->name ?></option>
                            ...
                            <select name="winside" id="winside" class="form-control" required >
                                ...
                                if (!empty($water_source_location)) {
                                    foreach ($water_source_location as $water_source_location_single) {
                                        ?>
                                        <option  value="<?php echo $water_source_location_single->id; ?>"><?php echo $water_source_location_single->code.'-'.$water_source_location_single->name ?></option>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input onkeypress='return event.charCode >= 48 && event.charCode <= 57' type="text" class="form-control" id="wcol_time" name="wcol_time">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="wait_time">অপেক্ষামান সময়(মিনিট)<span style="color:red;">*</span></label>
                                <input onkeypress='return event.charCode >= 48 && event.charCode <= 57' type="text" class="form-control" id="wait_time" name="wait_time">
                            </div>
                        </div>
                    </div>
                </fieldset>
                <div class="row">
                            ...
                            <select name="wat_coll" id="wat_coll" class="form-control" required >
                                ...
                                if (!empty($water_collector)) {
                                    foreach ($water_collector as $water_collector_single) {
                                        ?>
                                        <option  value="<?php echo $water_collector_single->id; ?>"><?php echo $water_collector_single->code.'-'.$water_collector_single->name ?></option>
                    ...
                    <div class="col-md-6 wat_coll_other_part">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="wat_coll_other" name="watcoloth">
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6 wsharef_part">
                        <div class="form-group">
                            ...
                            <input onkeypress='return event.charCode >= 48 && event.charCode <= 57' type="text" class="form-control" id="wsharef" name="wsharef">
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <select name="wat_supp" id="wat_supp" class="form-control" required >
                                ...
                                if (!empty($water_supplier)) {
                                    foreach ($water_supplier as $water_supplier_single) {
                                        ?>
                                        <option  value="<?php echo $water_supplier_single->id; ?>"><?php echo $water_supplier_single->code.'-'.$water_supplier_single->name ?></option>
                    ...
                    <div class="col-md-6 wat_supp_other_part">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="wat_supp_other" name="w_suppoth">
                        </div>
                    </div>
                </div>
                <div class="row">
                                ...
                                <select name="toilet" id="toilet" class="form-control" required >
                                    ...
                                    if (!empty($toilet_type)) {
                                        foreach ($toilet_type as $toilet_type_single) {
                                            ?>
                                            <option  value="<?php echo $toilet_type_single->id ?>"><?php echo $toilet_type_single->code.'-'.$toilet_type_single->name; ?></option>
                    ...
                    <div class="row">
                                ...
                                <select name="toilet_ct" id="toilet_ct" class="form-control" required >
                                    ...
                                    if (!empty($dirt_removing_type)) {
                                        foreach ($dirt_removing_type as $dirt_removing_type_single) {
                                            ?>
                                            <option  value="<?php echo $dirt_removing_type_single->id ?>"><?php echo $dirt_removing_type_single->code.'-'.$dirt_removing_type_single->name; ?></option>
                        ...
                        <div class="col-md-6 toilet_ct_ot_part">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="toilet_ct_ot" name="toilet_ct_ot">
                            </div>
                        </div>
                    </div>
                </fieldset>
                ...
                <div class="row">
                            ...
                            <select name="toilet_cl" id="toilet_cl" class="form-control" required >
                                ...
                                if (!empty($toilet_cleaner)) {
                                    foreach ($toilet_cleaner as $toilet_cleaner_single) {
                                        ?>
                                        <option  value="<?php echo $toilet_cleaner_single->id; ?>"><?php echo $toilet_cleaner_single->code.'-'.$toilet_cleaner_single->name ?></option>
                    ...
                    <div class="col-md-6 toilet_coth_part">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="toilet_coth" name="toilet_coth">
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <select name="toilet_dis" id="toilet_dis" class="form-control" required >
                                ...
                                if (!empty($toilet_dirt_remover)) {
                                    foreach ($toilet_dirt_remover as $toilet_dirt_remover_single) {
                                        ?>
                                        <option  value="<?php echo $toilet_dirt_remover_single->id; ?>"><?php echo $toilet_dirt_remover_single->code.'-'.$toilet_dirt_remover_single->name ?></option>
                    ...
                    <div class="col-md-6 toilet_dot_part">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="toilet_dot" name="toilet_dot">
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 tsharef_part">
                        <div class="form-group">
                            ...
                            <input onkeypress='return event.charCode >= 48 && event.charCode <= 57' type="text" name="tsharef" id="tsharef" class="form-control">
                ...
                <div class="row">
                            ...
                            <select name="light" id="light" class="form-control" required >
                                ...
                                if (!empty($light_source)) {
                                    foreach ($light_source as $light_source_single) {
                                        ?>
                                        <option  value="<?php echo $light_source_single->id; ?>"><?php echo $light_source_single->code.'-'.$light_source_single->name ?></option>
                    ...
                    <div class="col-md-6 light_oth_part">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="light_oth" name="light_oth">
                        </div>
                    </div>
                </div>
            </fieldset>
                ...
                <div class="row">
                            ...
                            <select name="Q62" id="Q62" class="form-control">
                                ...
                                if (!empty($hand_washing_place)) {
                                    foreach ($hand_washing_place as $hand_washing_place_single) {
                                        ?>
                                        <option  value="<?php echo $hand_washing_place_single->id; ?>"><?php echo $hand_washing_place_single->code.'-'.$hand_washing_place_single->name ?></option>
                    ...
                    <div class="col-md-4 Q62oth_part">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="Q62oth" name="Q62oth">
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <select name="Q63" id="Q63" class="form-control" required >
                                ...
                                if (!empty($hand_washing_arrangement)) {
                                    foreach ($hand_washing_arrangement as $hand_washing_arrangement_single) {
                                        ?>
                                        <option  value="<?php echo $hand_washing_arrangement_single->id; ?>"><?php echo $hand_washing_arrangement_single->code.'-'.$hand_washing_arrangement_single->name ?></option>
                    ...
                    <div class="col-md-6 Q63oth_part">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="Q63oth" name="Q63oth">
                        </div>
                    </div>
                </div>
                <fieldset class="scheduler-border">
                                ...
                                <select name="Q65A" id="Q65A" class="form-control" required >
                                    ...
                                    if (!empty($spontaneously_afterTelling_dontKnow)) {
                                        foreach ($spontaneously_afterTelling_dontKnow as $spontaneously_afterTelling_dontKnow_single) {
                                            ?>
                                            <option  value="<?php echo $spontaneously_afterTelling_dontKnow_single->id ?>"><?php echo $spontaneously_afterTelling_dontKnow_single->code.'-'.$spontaneously_afterTelling_dontKnow_single->name; ?></option>
                ...
                <div class="row">
                            ...
                            <select name="cook" id="cook" class="form-control" required >
                                ...
                                if (!empty($fuel_type)) {
                                    foreach ($fuel_type as $fuel_type_single) {
                                        ?>
                                        <option  value="<?php echo $fuel_type_single->id ?>"><?php echo $fuel_type_single->code.'-'.$fuel_type_single->name; ?></option>
                    ...
                    <div class="col-md-6 cookoth_part">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="cookoth" name="cookoth">
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 csharef_part">
                        <div class="form-group">
                            ...
                            <input type="text" name="csharef" id="csharef" class="allowDecimalOrInteger form-control">
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <select name="garbage" id="garbage" class="form-control" required >
                                ...
                                if (!empty($dirt_taken_place)) {
                                    foreach ($dirt_taken_place as $dirt_taken_place_single) {
                                        ?>
                                        <option  value="<?php echo $dirt_taken_place_single->id ?>"><?php echo $dirt_taken_place_single->code.'-'.$dirt_taken_place_single->name; ?></option>
                    ...
                    <div class="col-md-6 garbageoth_part">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="garbageoth" name="garbageoth">
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <select name="gcollect" id="gcollect" class="form-control" required >
                                ...
                                if (!empty($dirt_collection_time)) {
                                    foreach ($dirt_collection_time as $dirt_collection_time_single) {
                                        ?>
                                        <option  value="<?php echo $dirt_collection_time_single->id; ?>"><?php echo $dirt_collection_time_single->code.'-'.$dirt_collection_time_single->name ?></option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 resp_ind_part">
                        <div class="form-group">
                            ...
                            <input type="text" name="resp_ind" id="resp_ind" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="imobile" id="imobile" class="form-control" required >
                        </div>
                    </div>
					<div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="ten_perceent" id="ten_perceent" class="form-control" >
                                ...
                                if (!empty($yes_no)) {
                                    foreach ($yes_no as $yes_no_house) {
                                        ?>
                                        <option  value="<?php echo $yes_no_house->id; ?>"><?php echo $yes_no_house->code.'-'.$yes_no_house->name ?></option>
