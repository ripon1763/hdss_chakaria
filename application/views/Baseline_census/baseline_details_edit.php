...
<form action="<?php echo base_url() . 'Baseline_census/editBaselineDetails?baseID=' . $baseID ?>" id="myForm" role="form" data-toggle="validator" method="post" accept-charset="utf-8">
