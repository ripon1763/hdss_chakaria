                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="col-md-4 form-group">
                                                    <label>
                                                        7.24.1) একজন পেশাজীবি (স্বাস্থ্য) কর্তৃক উনার কোভিট-১৯ নির্ণয় হয়েছিল কি?
                                                    </label>
                                                    <select id="Q7_24_1_A" name="Q7_24_1_A" class="form-control">
                                                        <option id="0" value="">নির্বাচন করুন</option>
                                                        <?php foreach ($va_yes_no as $va_yes_no_single) { ?>
                                                            <option <?php if ($userInfo->Q7_24_1_A == $va_yes_no_single->id) echo ' selected'; ?> value="<?php echo $va_yes_no_single->id; ?>"><?php echo $va_yes_no_single->name; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-4 form-group">
                                                    <label>
                                                        7.24.2) কোভিট-১৯ নির্ণয়ে সম্প্রতি উনার পরীক্ষা করা হয়েছিল?
                                                    </label>
                                                    <select id="Q7_24_2_A" name="Q7_24_2_A" class="form-control">
                                                        <option id="0" value="">নির্বাচন করুন</option>
                                                        <?php foreach ($va_yes_no as $va_yes_no_single) { ?>
                                                            <option <?php if ($userInfo->Q7_24_2_A == $va_yes_no_single->id) echo ' selected'; ?> value="<?php echo $va_yes_no_single->id; ?>"><?php echo $va_yes_no_single->name; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>

                                                <div class="col-md-4 form-group Q7_24_3_A_off">
                                                    <label>
                                                        7.24.3) সর্বশেষ পরীক্ষার ফলাফল কি ছিল?
                                                    </label>
                                                    <select id="Q7_24_3_A" name="Q7_24_3_A" class="form-control">
                                                        <option id="0" value="">নির্বাচন করুন</option>
                                                        <?php foreach ($Covid_Positive_Negative as $Covid_Positive_Negative_Single) { ?>
                                                            <option <?php if ($userInfo->Q7_24_3_A == $Covid_Positive_Negative_Single->id) echo ' selected'; ?> value="<?php echo $Covid_Positive_Negative_Single->id; ?>"><?php echo $Covid_Positive_Negative_Single->name; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    <label>
                                                        7.24.4) উনি কি অতিরিক্ত ক্লান্তিতে ভুগছিলেন?
                                                    </label>
                                                    <select id="Q7_24_4_A" name="Q7_24_4_A" class="form-control">
                                                        <option id="0" value="">নির্বাচন করুন</option>
                                                        <?php foreach ($va_yes_no as $va_yes_no_single) { ?>
                                                            <option <?php if ($userInfo->Q7_24_4_A == $va_yes_no_single->id) echo ' selected'; ?> value="<?php echo $va_yes_no_single->id; ?>"><?php echo $va_yes_no_single->name; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-4 form-group">
                                                    <label>
                                                        7.24.5) উনার এমন অবস্থা হয়েছিল কিনা? (বিছানা থেকে উঠা, গোসল করা বা পরনের কাপড় বদলানোই কঠিন মনে হয়েছে)
                                                    </label>
                                                    <select id="Q7_24_5_A" name="Q7_24_5_A" class="form-control">
                                                        <option id="0" value="">নির্বাচন করুন</option>
                                                        <?php foreach ($va_yes_no as $va_yes_no_single) { ?>
                                                            <option <?php if ($userInfo->Q7_24_5_A == $va_yes_no_single->id) echo ' selected'; ?> value="<?php echo $va_yes_no_single->id; ?>"><?php echo $va_yes_no_single->name; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-4 form-group">
                                                    <label>
                                                        7.24.6) উনার কি হঠাৎ খাবারের স্বাদ না লাগা, গন্ধ কমে যাওয়া বা লোপ পাওয়া এমন অবস্থা হযেছিল?
                                                    </label>
                                                    <select id="Q7_24_6_A" name="Q7_24_6_A" class="form-control">
                                                        <option id="0" value="">নির্বাচন করুন</option>
                                                        <?php foreach ($va_yes_no as $va_yes_no_single) { ?>
                                                            <option <?php if ($userInfo->Q7_24_6_A == $va_yes_no_single->id) echo ' selected'; ?> value="<?php echo $va_yes_no_single->id; ?>"><?php echo $va_yes_no_single->name; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    <label>
                                                        7.24.7) উনার মৃত্যুর দুই সপ্তাহ পূর্বে ইনি কি করোনা রোগীর সংস্পর্শে বা সেবা যত্নের কাজ করছিলেন? (Live, visit, care)
                                                    </label>
                                                    <select id="Q7_24_7_A" name="Q7_24_7_A" class="form-control">
                                                        <option id="0" value="">নির্বাচন করুন</option>
                                                        <?php foreach ($va_yes_no as $va_yes_no_single) { ?>
                                                            <option <?php if ($userInfo->Q7_24_7_A == $va_yes_no_single->id) echo ' selected'; ?> value="<?php echo $va_yes_no_single->id; ?>"><?php echo $va_yes_no_single->name; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-4 form-group">
                                                    <label>
                                                        7.24.8) মৃত্যুর দুই সপ্তাহ পূর্বে করোনা রোগ আছে এমন জায়গায় গিয়েছিলেন?
                                                    </label>
                                                    <select id="Q7_24_8_A" name="Q7_24_8_A" class="form-control">
                                                        <option id="0" value="">নির্বাচন করুন</option>
                                                        <?php foreach ($va_yes_no as $va_yes_no_single) { ?>
                                                            <option <?php if ($userInfo->Q7_24_8_A == $va_yes_no_single->id) echo ' selected'; ?> value="<?php echo $va_yes_no_single->id; ?>"><?php echo $va_yes_no_single->name; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
...
<script>
    <?php if ($logged_in_user_role_id==4){ ?>
    $("#disable_portion :input").attr("disabled", true);
    <?php } ?>
