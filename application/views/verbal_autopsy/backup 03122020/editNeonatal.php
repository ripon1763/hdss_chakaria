                            ...
                            <div class="row">
                                ...
                                <div <?php if ($userInfo->Q5_1_3 == 1576) echo " style='display:none;'" ?> class="col-md-12 Q5_1_3_no_reluctant_unknown">
                                    <div class="form-group col-md-4"> 
                                        ...
                                        <select id="Q6_2_6_1" class="form-control" name="Q6_2_6_1">
                                            <option id="0" value="">নির্বাচন করুন</option>
                                            <?php foreach ($VA_Related_To_EDD as $VA_Related_To_EDD_single) { ?>
                                                <option <?php if ($userInfo->Q6_2_6_1 == $VA_Related_To_EDD_single->id) echo ' selected'; ?> value="<?php echo $VA_Related_To_EDD_single->id; ?>"><?php echo $VA_Related_To_EDD_single->name; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-4">
                                ...
                                <div <?php if ($userInfo->Q5_1_3 == 1576) echo " style='display:none;'" ?> class="col-md-12 Q5_1_3_no_reluctant_unknown">
                                    ...
                                    <div <?php if ($userInfo->Q7_6 != 1576) echo " style='display:none;'" ?> class="col-md-4 form-group Q7_6_yes_part">
                                        ...
                                        <input value="<?php echo $userInfo->Q7_6_1_D; ?>" id="Q7_6_1_D" name="Q7_6_1_D" type="text" style="width: 50%;float: left;" class="form-control" placeholder="দিন">
                                        <input value="<?php echo $userInfo->Q7_6_1_H; ?>" id="Q7_6_1_H" name="Q7_6_1_H" type="text" style="width: 50%;float: left;" class="form-control" placeholder="ঘন্টা">
                                    </div>
                                </div>
								<div class="box-footer col-md-12" style="margin-left:20px;margin-right:20px">
                                    <input type="submit" class="btn btn-primary" value="Update">
                                ...
                                <div <?php if ($userInfo->Q5_1_3 == 1576) echo " style='display:none;'" ?> class="col-md-12 Q5_1_3_no_reluctant_unknown">
                                    <div <?php if ($userInfo->Q7_15 != 1916) echo " style='display:none;'" ?> class="col-md-4 form-group Q7_15_1_part">
                                        <label>
                                ...
                                ?> class="col-md-12 Q8_3_1_part">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input value="<?php echo $userInfo->Q8_3_1_BLOCK_NAME; ?>" id="Q8_3_1_BLOCK_NAME" name="Q8_3_1_BLOCK_NAME" type="text" class="form-control" placeholder="গ্রামের নাম">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>
                                            ব্লক কোড
                                        </label>
                                        <input value="<?php echo $userInfo->Q8_3_1_BLOCK_CODE; ?>" id="Q8_3_1_BLOCK_CODE" name="Q8_3_1_BLOCK_CODE" type="text" class="form-control" placeholder="গ্রামের নাম">
                                    </div>
                                </div>
