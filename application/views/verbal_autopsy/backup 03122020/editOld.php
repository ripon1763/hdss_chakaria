                            ...
                            <div class="row">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <select name="Q1_1_N1" class="form-control" id="Q1_1_N1">
                                            ...
                                            foreach ($household_member as $household) {
                                                ?>
                                                <option <?php  if ($userInfo->Q1_1_N1 == $household->MEMBER_CODE) { echo 'selected=selected'; } ?> value="<?php echo $household->MEMBER_CODE; ?>"><?php echo $household->MEMBER_CODE.'-'.$household->MEMBER_NAME; ?></option>
                                                    <?php
                                        ...
                                        <label>2. সাক্ষাৎকার গ্রহনের সময় উপস্থিত ব্যক্তির নাম:</label>
                                         <select name="Q1_1_N2" class="form-control" id="Q1_1_N2">
                                            ...
                                            foreach ($household_member as $household2) {
                                                ?>
                                                <option <?php  if ($userInfo->Q1_1_N2 == $household2->MEMBER_CODE) { echo 'selected=selected'; } ?> value="<?php echo $household2->MEMBER_CODE; ?>"><?php echo $household2->MEMBER_CODE.'-'.$household2->MEMBER_NAME; ?></option>
                                                    <?php
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <select name="Q1_1_N3" class="form-control" id="Q1_1_N3">
                                            ...
                                            foreach ($household_member as $household3) {
                                                ?>
                                                <option <?php  if ($userInfo->Q1_1_N3 == $household3->MEMBER_CODE) { echo 'selected=selected'; } ?> value="<?php echo $household3->MEMBER_CODE; ?>"><?php echo $household3->MEMBER_CODE.'-'.$household3->MEMBER_NAME; ?></option>
                                                    <?php
                                ...
                                <div class="col-md-12"> 
                                    <div class="col-md-4 form-group">
										...
										<?php if($userInfo->Q2_1_INTV_NAME == '') {
                                ...
                                <div <?php if ($userInfo->FK_SEX == 466) echo " style='display:none;'" ?> class="col-md-12 Q5_1_no_reluctant_unknown_female">
                                    <div class="col-md-4 form-group">
                                        ...
                                        ?>
                                        <input value="<?php  echo $Q6_2_2; ?>" autocomplete="off" name="Q6_2_2" type="text" class="datepicker form-control">
                                ...
                                <div class="col-md-12">
									...
									<div class="col-md-4 form-group">
                                        ...
                                        <select name="inv_status" class="form-control">
                                            <option <?php if($userInfo->inv_status == 0) { echo "selected=selected"; }  ?>  value="0">incomplete</option>
                                            <option <?php if($userInfo->inv_status == 1) { echo "selected=selected"; }  ?> value="1">complete</option>
