                    ...
                    <form action="<?php echo base_url() . $controller . '/' . $actionMethod . '?baseID=' . $baseID ?>" method="post" id="editUser" role="form">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div <?php if ($userInfo->FK_SEX == 466 || $userInfo->Q6_2_3 == 1635) echo " style='display:none;'" ?> class="col-md-12 Q5_1_no_reluctant_unknown_female Q6_2_3_Not_Delivery">
                                    <div class="col-md-4 form-group">
                                ...
                                <div <?php if ($userInfo->FK_SEX == 466 || $userInfo->Q6_2_3 == 1635) echo " style='display:none;'" ?> class="col-md-12 Q5_1_no_reluctant_unknown_female Q6_2_3_Not_Delivery Q6_2_14_part">
                                    <div class="col-md-4 form-group">
                                        <label>
                                            ডাক্তার
                                        </label>
