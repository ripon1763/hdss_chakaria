        ...
        <div class="row">
            ...
            <div class="col-xs-6 text-right">
                <div class="form-group margin5pxBot">
                    ...
                    <a class="btn btn-primary" href="<?php echo base_url() . $controller . '/child?baseID=' . $baseID ?>">Child List</a>
                </div>
            </div>
        </div>
    </section>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-4 form-group">
                                        ...
                                        ?>
                                        <input value="<?php echo $name ?>" name="Q2_1_INTV_NAME2" type="text" class="form-control" disabled>
                                        <input value="<?php echo $name ?>" name="Q2_1_INTV_NAME" type="hidden" class="form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>কোড:</label>
                                        <input value="<?php echo $intervcode; ?>" name="Q2_1_INTV_CODE2" type="text" class="form-control" disabled>
                                        <input value="<?php echo $intervcode; ?>" name="Q2_1_INTV_CODE" type="hidden" class="form-control">
                                    </div>
                                    <div class="form-group col-md-4">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input value="<?php echo $birth_date; ?>" class="form-control" disabled>
                                    </div>
                                    <div class="col-md-4">
                                        <br/>
                                        <label for="Item Name"><b>3.7</b>&nbsp;শিশুর মৃত্যু তারিখ (দিন/মাস/বছর)</label>
                                        <input value="<?php echo $death_date; ?>" class="form-control" disabled>
                                    </div>
                                    <div class="col-md-4">
                                        <br/>
                                        <label for="Item Name"><b>3.8</b>&nbsp;মৃত্যুকালে বয়স (দিন)</label>
                                        <input type="number" class="form-control" value="<?php echo $year1; ?>" name="Q3_7_AGE_Y">
                                    </div>
                                    <div class="col-md-4">
                                        <br/>
                                    ...
                                    <div class="col-md-8">
                                        <br/>
                                        <label for="Item Name"><b>3.13</b>&nbsp;তাহার বৈবাহিক অব¯হা কি? 
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-4">
                                        ...
                                        <input value="<?php echo $userInfo->Q4_3_M; ?>" name="Q4_3_M"  placeholder="মাস" type="text" class="form-control col-md-4">
                                        <input value="<?php echo $userInfo->Q4_3_D; ?>" name="Q4_3_D" placeholder="দিন" type="text" class="form-control col-md-4">
                                    </div>
                                    <div class="col-md-4">
                                        <br/>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div <?php
                                    if ($userInfo->Q5_1 == 1576)
                                        echo " style='display:block'";
                                    else
                                        echo " style='display:none'";
                                    ?> class="col-md-4 form-group Q5_1_no_reluctant_unknown">
                                        <label>
                                ...
                                if ($userInfo->Q5_1 == 1576)
                                    ...
                                    echo " style='display:none'";
                                ?> class="col-md-12 Q5_1_no_reluctant_unknown">
                                    <div class="col-md-4 form-group">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_1 == 1577 || $userInfo->Q6_1 == 1578 || $userInfo->Q6_1 == 1579) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_1_no_reluctant_unknown">
                                        <label><b>6.1.1</b> &nbsp;মৃত শিশুর মা কত মাস গর্ভবতী ছিলেন?</label>
                                        <input value="<?php echo $userInfo->Q6_1_1; ?>" id="Q6_1_1" name="Q6_1_1" type="number" placeholder="মাস" class="form-control">
                                    </div>
                                    <div <?php if ($userInfo->Q6_1 == 1577 || $userInfo->Q6_1 == 1578 || $userInfo->Q6_1 == 1579) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_1_no_reluctant_unknown">
...
<?php } ?>
                                ...
                                <div <?php if ($userInfo->Q6_1 == 1577 || $userInfo->Q6_1 == 1578 || $userInfo->Q6_1 == 1579) echo " style='display:none'"; ?> class="col-md-12 Q5_1_8_no_reluctant_unknown Q6_1_no_reluctant_unknown">
                                    <div class="col-md-4 form-group">
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_1_3 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_1_3_no_reluctant_unknown">
                                        <label><b>6.1.4</b>&nbsp;মৃত্যুর কত দিন আগে চাঁদি ফুলে ছিল?<br/>
                                            Code: 00 = জন্ম থেকে)</label>
                                        <input value="<?php echo $userInfo->Q6_1_4_D; ?>" id="Q6_1_4_D" name="Q6_1_4_D" type="number" placeholder="দিন" class="form-control">
                                    </div>
...
<?php } ?>
                                ...
                                <div <?php if ($userInfo->Q6_1 == 1577 || $userInfo->Q6_1 == 1578 || $userInfo->Q6_1 == 1579) echo " style='display:none'"; ?> class="col-md-12 Q5_1_8_no_reluctant_unknown Q6_1_no_reluctant_unknown">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="text" value="<?php echo $userInfo->Q6_1_9_3_alive; ?>" id="Q6_1_9_3_alive" name="Q6_1_9_3_alive" style="width: 33%;float: left;" placeholder="জীবিতজন্ম" class="form-control">
                                        <input type="text" value="<?php echo $userInfo->Q6_1_9_3_dead; ?>" id="Q6_1_9_3_dead" name="Q6_1_9_3_dead" style="width: 33%;float: left;" placeholder="মৃত সন্তান" class="form-control">
                                        <input type="text" value="<?php echo $userInfo->Q6_1_9_3_Normal_delivery; ?>" id="Q6_1_9_3_Normal_delivery" name="Q6_1_9_3_Normal_delivery" style="width: 33%;float: left;" placeholder="গর্ভপাত (স্বতঃস্ফুর্তভাবে/ইচ্ছাকৃত)" class="form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>
                                        ...
                                        <input value="<?php echo $userInfo->Q6_1_9_4; ?>" id="Q6_1_9_4" name="Q6_1_9_4" type="text" placeholder="গ্রাম" class="form-control">&nbsp;&nbsp;(১ কেজি = ১০০০ গ্রাম)
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_2_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_2_1_no_reluctant_unknown">
                                        <label>
                                            <b>6.2.2</b>&nbsp;তার কতদিন/মাস যাবৎ জ্বর ছিল?
                                            <br/>(Code: 99 = অজানা)
                                        </label>
                                        <input value="<?php echo $userInfo->Q6_2_2_M; ?>" id="Q6_2_2_M" name="Q6_2_2_M" type="number" style="width: 50%;float: left;" placeholder="মাস" class="form-control">
                                        <input value="<?php echo $userInfo->Q6_2_2_D; ?>" id="Q6_2_2_D" name="Q6_2_2_D" type="number" style="width: 50%;float: left;" placeholder="দিন" class="form-control">
                                    </div>
                                    <div <?php if ($userInfo->Q6_2_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_2_1_no_reluctant_unknown">
                                        <label>
...
<?php } ?>
                                ...
                                <div <?php if ($userInfo->Q6_2_1 != 1576) echo " style='display:none'"; ?> class="col-md-12 Q5_1_8_no_reluctant_unknown Q6_2_1_no_reluctant_unknown">
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_3_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_3_1_yes">
                                        <label>
                                            <b>6.3.2</b>&nbsp;কতদিন যাবৎ গায়ে দানা/লালচে গোটা ছিল?
                                        </label>
                                        <input value="<?php echo $userInfo->Q6_3_2_M; ?>" id="Q6_3_2_M" name="Q6_3_2_M" type="text" style="width: 50%;float: left;" placeholder="মাস" class="form-control">
                                        <input value="<?php echo $userInfo->Q6_3_2_D; ?>" id="Q6_3_2_D" name="Q6_3_2_D" type="text" style="width: 50%;float: left;" placeholder="দিন" class="form-control">
                                    </div>
                                    <div <?php if ($userInfo->Q6_3_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_3_1_yes">
                                        <label>
...
?>
                                ...
                                <div class="col-md-12 Q5_1_8_no_reluctant_unknown">
                                    <div <?php
                                        if ($userInfo->Q6_3_6 > 1683 && $userInfo->Q6_3_6 < 1690)
                                            echo " style='display:block'";
                                        else
                                            echo " style='display:none'";
                                        ?> class="col-md-4 form-group Q6_3_6_applicable">
                                        <label>
...
<?php } ?>
                                ...
                                <div class="col-md-12 form-group Q5_1_8_no_reluctant_unknown">
                                    <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_3_12 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_3_12_yes">
                                        <label>
                                            <b>6.3.13</b>&nbsp;জ্যাবড়া/ছোপ ছোপ দাগ কত দিন ছিল?
                                        </label>
                                        <input value="<?php echo $userInfo->Q6_3_13; ?>" id="Q6_3_13" name="Q6_3_13" type="text" placeholder="দিন" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12 Q5_1_8_no_reluctant_unknown">
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_3_14 != 1576) echo " style='display:none'"; ?> class="col-md-8 form-group Q6_3_14_yes">
                                        <label>
...
?>
                                ...
                                <div class="col-md-12 Q5_1_8_no_reluctant_unknown">
                                    <div <?php if ($userInfo->Q6_3_14 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_3_14_yes">
                                        <label>
                                            <b>6.3.16</b>&nbsp;কত মাস/বছর যাবৎ ছিটছিটে সাদা/কালো দাগ/গুটি ছিল?
                                            (Code: 99 = অজানা)
                                        </label>
                                        <input value="<?php echo $userInfo->Q6_3_16_Y; ?>" id="Q6_3_16_Y" name="Q6_3_16_Y" type="text" style="width: 50%;float: left;" placeholder="বছর" class="form-control">
                                        <input value="<?php echo $userInfo->Q6_3_16_M; ?>" id="Q6_3_16_M" name="Q6_3_16_M" type="text" style="width: 50%;float: left;" placeholder="মাস" class="form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_3_17 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_3_17_yes">
                                        <label>
                                            <b>6.3.18</b>&nbsp;কত মাস/বছর যাবৎ হাতের তালু ও পাঁয়ের তলায় শক্ত/গুটিগুটি এই দাগগুলি ছিল?
                                            (Code: 99 = অজানা)
                                        </label>
                                        <input value="<?php echo $userInfo->Q6_3_18_Y; ?>" id="Q6_3_18_Y" name="Q6_3_18_Y" type="text" style="width: 50%;float: left;" placeholder="বছর" class="form-control">
                                        <input value="<?php echo $userInfo->Q6_3_18_M; ?>" id="Q6_3_18_M" name="Q6_3_18_M" type="text" style="width: 50%;float: left;" placeholder="মাস" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12 Q5_1_8_no_reluctant_unknown">
                                    <div class="col-md-4 form-group">
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_3_19 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_3_19_yes">
                                        <label>
...
<?php } ?>
                                ...
                                <div <?php if ($userInfo->Q6_3_21 != 1576) echo " style='display:none'"; ?> class="col-md-12 Q5_1_8_no_reluctant_unknown Q6_3_21_yes">
                                    <div class="col-md-4 form-group">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_4 != 1948) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_4_yes">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_4a != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_4a_yes">
                                        <label>
...
<?php } ?>
                                ...
                                <div class="col-md-12 Q5_1_8_no_reluctant_unknown">
                                    <div <?php if ($userInfo->Q6_4b != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_4b_yes">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_4c != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_4c_yes">
                                        <label>
                                            <b>6.4d</b>&nbsp;জন্মের কত দিন পর দুধপান বন্ধ করে দিয়েছিল?
                                        </label>
                                        <input value="<?php echo $userInfo->Q6_4d_M; ?>" id="Q6_4d_M" name="Q6_4d_M" type="text" style="width: 50%;float: left;" placeholder="মাস" class="form-control">
                                        <input value="<?php echo $userInfo->Q6_4d_D; ?>" id="Q6_4d_D" name="Q6_4d_D" type="text" style="width: 50%;float: left;" placeholder="দিন" class="form-control">
                                    </div>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_4_3 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_4_4_part">
                                        <label>
                                            <b>6.4.4</b>&nbsp;কত মাস/দিন যাবৎ তার ওজন কমে গিয়েছিল?
                                        </label>
                                        <input value="<?php echo $userInfo->Q6_4_4_M; ?>" id="Q6_4_4_M" name="Q6_4_4_M" type="text" style="width: 50%;float: left;" placeholder="মাস" class="form-control">
                                        <input value="<?php echo $userInfo->Q6_4_4_D; ?>" id="Q6_4_4_D" name="Q6_4_4_D" type="text" style="width: 50%;float: left;" placeholder="দিন" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12 Q5_1_8_no_reluctant_unknown">
...
<?php } ?>
                                            ...
                                            <tr><td style="text-align: left;">&nbsp;কানের গঠনে ত্রূটি</td>
                                                <td>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_5_1_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_5_2_part">
                                        <label>
                                            <b>6.5.2</b>&nbsp;কত দিন যাবৎ তাকে ফ্যাকাশে দেখাচ্ছিল?
                                        </label>
                                        <input value="<?php echo $userInfo->Q6_5_2_M; ?>" id="Q6_5_2_M" name="Q6_5_2_M" type="text" style="width: 50%;float: left;" placeholder="মাস" class="form-control">
                                        <input value="<?php echo $userInfo->Q6_5_2_D; ?>" id="Q6_5_2_D" name="Q6_5_2_D" type="text" style="width: 50%;float: left;" placeholder="দিন" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12 Q5_1_8_no_reluctant_unknown">
                                    <div class="col-md-4 form-group">
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_5_3 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_5_4_part">
                                        <label>
                                            <b>6.5.4</b>&nbsp;কত দিন তাকে হলদে দেখাত?
                                        </label>
                                        <input value="<?php echo $userInfo->Q6_5_4; ?>" id="Q6_5_4" type="text" name="Q6_5_4" placeholder="দিন" class="form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_6_1 != 1576) echo " style='display:none'"; ?> class="col-md-8 form-group Q6_6_1_yes">
                                        <label>
...
?>
                                ...
                                <div class="col-md-12 Q5_1_8_no_reluctant_unknown">
                                    <div <?php if ($userInfo->Q6_6_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_6_1_yes">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_6_3_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_6_3_2_part">
                                        <label>
                                            <b>6.6.3.2</b>&nbsp;এই ফুলা কত মাস / দিন স্থায়ী হয়েছিল?
                                        </label>
                                        <input value="<?php echo $userInfo->Q6_6_3_2_M; ?>" id="Q6_6_3_2_M" name="Q6_6_3_2_M" type="text" style="width: 50%;float: left;" placeholder="মাস" class="form-control">
                                        <input value="<?php echo $userInfo->Q6_6_3_2_D; ?>" id="Q6_6_3_2_D" name="Q6_6_3_2_D" type="text" style="width: 50%;float: left;" placeholder="দিন" class="form-control">
                                    </div>
                                    <div class="box-footer col-md-12">
                                        <input type="submit" class="btn btn-primary" value="Update">
                                    </div>
...
<?php } ?>
                                    ...
                                    <div class="col-md-4 form-group">
                                        <label>
                                            <b>6.6.7</b>&nbsp;তরল পান করতে গলায় ব্যথা হতো?
                                        </label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_7_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_7_1_yes">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_7_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_7_1_yes">
                                        ...
                                        <input value="<?php echo $userInfo->Q6_7_2_M; ?>" id="Q6_7_2_M" name="Q6_7_2_M" type="text" style="width: 50%;float: left;" placeholder="মাস" class="form-control">
                                        <input value="<?php echo $userInfo->Q6_7_2_D; ?>" id="Q6_7_2_D" name="Q6_7_2_D" type="text" style="width: 50%;float: left;" placeholder="দিন" class="form-control">
                                    </div>
                                </div>
                                <div <?php if ($userInfo->Q6_7_1 != 1576) echo " style='display:none'"; ?> class="col-md-12 Q5_1_8_no_reluctant_unknown Q6_7_1_yes">
                                    <div class="col-md-4 form-group">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_8_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_8_2_part">
                                        <label>
                                            <b>6.8.2</b>&nbsp;কত দিন যাবৎ শ্বাস কষ্ট ছিল?
                                        </label>
                                        <input value="<?php echo $userInfo->Q6_8_2_M; ?>" id="Q6_8_2_M" name="Q6_8_2_M" type="text" style="width: 50%;float: left;" placeholder="মাস" class="form-control">
                                        <input value="<?php echo $userInfo->Q6_8_2_D; ?>" id="Q6_8_2_D" name="Q6_8_2_D" type="text" style="width: 50%;float: left;" placeholder="দিন" class="form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>
...
<?php } ?>
                                ...
                                <div class="col-md-12 Q5_1_8_no_reluctant_unknown">
                                    <div <?php if ($userInfo->Q6_8_3 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_8_4_part">
                                        <label>
                                            <b>6.8.4</b>&nbsp;কত দিন যাবৎ সে দ্রুত শ্বাস নিয়েছিল?
                                        </label>
                                        <input value="<?php echo $userInfo->Q6_8_4_M; ?>" id="Q6_8_4_M" name="Q6_8_4_M" type="text" style="width: 50%;float: left;" placeholder="মাস" class="form-control">
                                        <input value="<?php echo $userInfo->Q6_8_4_D; ?>" id="Q6_8_4_D" name="Q6_8_4_D" type="text" style="width: 50%;float: left;" placeholder="দিন" class="form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_8_4_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_8_4_2_part">
                                        <label>
                                            <b>6.8.4.2</b>&nbsp;রুদ্ধশ্বাস / থেমে থেমে শ্বাস নেয়া  ভুগে থাকলে তা কতদিন স্থায়ী ছিল?
                                        </label>
                                        <input value="<?php echo $userInfo->Q6_8_4_2_M; ?>" id="Q6_8_4_2_M" name="Q6_8_4_2_M" type="text" style="width: 50%;float: left;" placeholder="মাস" class="form-control">
                                        <input value="<?php echo $userInfo->Q6_8_4_2_D; ?>" id="Q6_8_4_2_D" name="Q6_8_4_2_D" type="text" style="width: 50%;float: left;" placeholder="দিন" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12 Q5_1_8_no_reluctant_unknown">
                                    <div class="col-md-4 form-group">
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_9_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_9_1_yes">
                                        <label>
                                            <b>6.9.2</b>&nbsp;তার কত দিন ডায়রিয়া ছিল? (Code: 99 = অজানা)
                                        </label>
                                        <input value="<?php echo $userInfo->Q6_9_2; ?>" id="Q6_9_2" name="Q6_9_2" type="text" placeholder="দিন" class="form-control">
                                    </div>
                                    <div <?php if ($userInfo->Q6_9_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_9_1_yes">
                                        <label>
...
<?php } ?>
                                ...
                                <div <?php if ($userInfo->Q6_9_1 != 1576) echo " style='display:none'"; ?> class="col-md-12 Q5_1_8_no_reluctant_unknown Q6_9_1_yes">
                                    <div class="col-md-4 form-group">
                                        <label>
                                            <b>6.9.4</b>&nbsp;ডায়রিয়া যখন মারাত্বক ছিল, তখন দিনে কত বার পায়খানা হয়েছিল?
                                        </label>
                                        <input value="<?php echo $userInfo->Q6_9_4; ?>" id="Q6_9_4" name="Q6_9_4" type="text"  placeholder="বার " class="form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_9_7 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_9_8_part">
                                        <label>
                                        ...
                                        <select onchange="showHide(this.id, 'Q6_9_8_off')" name="Q6_9_8" class="form-control" id="Q6_9_8">
                                            ...
                                            foreach ($va_dysentery_stop_situation as $va_dysentery_stop_situation_single) {
                                                ...
                                                <option <?php if ($userInfo->Q6_9_8 == $va_dysentery_stop_situation_single->id) echo ' selected'; ?> <?php
                                                    if ($va_dysentery_stop_situation_single->code == 2)
                                                        echo " id='Q6_9_8_root'";
                                                    else
                                                        echo " id='Q6_9_8_" . $i . "'";
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_10_1 != 1576) echo " style='display:none'"; ?> class="col-md-3 form-group Q6_10_1_yes">
                                        <label>
                                            <b>6.10.2</b> &nbsp;তার কত দিন/ঘন্টা বমি ছিল?
                                        </label>
                                        <input value="<?php echo $userInfo->Q6_10_2_D; ?>" id="Q6_10_2_D" name="Q6_10_2_D" type="text" style="width: 50%;float: left;" placeholder="দিন" class="form-control">
                                        <input value="<?php echo $userInfo->Q6_10_2_H; ?>" id="Q6_10_2_H" name="Q6_10_2_H" type="text" style="width: 50%;float: left;" placeholder="ঘন্টা " class="form-control">
                                    </div>
                                    <div <?php if ($userInfo->Q6_10_1 != 1576) echo " style='display:none'"; ?> class="col-md-3 form-group Q6_10_1_yes">
                                        <label>
...
?>
                                    ...
                                    <div <?php if ($userInfo->Q6_10_1 != 1576) echo " style='display:none'"; ?> class="col-md-3 form-group Q6_10_1_yes">
                                        ...
                                        <input value="<?php echo $userInfo->Q6_10_4; ?>" id="Q6_10_4" name="Q6_10_4" type="text"  placeholder="বার" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12 Q5_1_8_no_reluctant_unknown">
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_11_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_11_1_yes">
                                        <label>
...
?>
                                    ...
                                    <div <?php if ($userInfo->Q6_10_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_11_1_yes">
                                        <label>
...
?>
                                ...
                                <div <?php if ($userInfo->Q6_11_1 != 1576) echo " style='display:none'"; ?> class="col-md-12 Q5_1_8_no_reluctant_unknown Q6_11_1_yes">
                                    <div class="col-md-4 form-group">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input value="<?php echo $userInfo->Q6_11_5_D; ?>" id="Q6_11_5_D" name="Q6_11_5_D" type="text" style="width: 50%;float: left;" placeholder="দিন" class="form-control">
                                        <input value="<?php echo $userInfo->Q6_11_5_H; ?>" id="Q6_11_5_H" name="Q6_11_5_H" type="text" style="width: 50%;float: left;" placeholder="ঘন্টা " class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12 Q5_1_8_no_reluctant_unknown">
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_12_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_12_1_yes">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_12_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_12_1_yes">
                                        ...
                                        <input value="<?php echo $userInfo->Q6_12_2_D; ?>" id="Q6_12_2_D" name="Q6_12_2_D" type="text" style="width: 50%;float: left;" placeholder="দিন" class="form-control">
                                        <input value="<?php echo $userInfo->Q6_12_2_H; ?>" id="Q6_12_2_H" name="Q6_12_2_H" type="text" style="width: 50%;float: left;" placeholder="ঘন্টা " class="form-control">
                                    </div>
                                </div>
                                <div <?php if ($userInfo->Q6_12_1 != 1576) echo " style='display:none'"; ?> class="col-md-12 Q5_1_8_no_reluctant_unknown Q6_12_1_yes">
                                    <div class="col-md-4 form-group">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_12_3 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_12_4_part">
                                        <label>
                                            <b>6.12.4</b>&nbsp;মৃত্যুর আগে কত দিন যাবৎ তার পায়খানা হতো না?
                                            (Code: 99 = অজানা)
                                        </label>
                                        <input value="<?php echo $userInfo->Q6_12_4; ?>" id="Q6_12_4" name="Q6_12_4" type="text" placeholder="দিন" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12 Q5_1_8_no_reluctant_unknown">
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_13_1 != 1576) echo " style='display:none'"; ?> class="col-md-3 form-group Q6_13_1_yes">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_13_1 != 1576) echo " style='display:none'"; ?> class="col-md-3 form-group Q6_13_1_yes">
                                        ...
                                        <input id="Q6_13_4" name="Q6_13_4" value="<?php echo $userInfo->Q6_13_4; ?>" type="text" placeholder="দিন" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12 Q5_1_8_no_reluctant_unknown">
                                    <b>6.14 মাথা ব্যথা (MASS)<br/><p style="color:red;font-size:14px;">Note: মৃত শিশুর বয়স পাঁচ বছরের বেশী হলে জিজ্ঞেস করুন।</p></b>
                                </div>
                                <div class="col-md-12 Q5_1_8_no_reluctant_unknown">
                                    <div class="col-md-4 form-group">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_14_1 != 1624) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_14_1_yes">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_14_1 != 1624) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_14_1_yes">
                                        ...
                                        <input value="<?php echo $userInfo->Q6_14_3_M; ?>" id="Q6_14_3_M" name="Q6_14_3_M" type="text" style="width: 50%;float: left;" placeholder="মাস" class="form-control">
                                        <input value="<?php echo $userInfo->Q6_14_3_D; ?>" id="Q6_14_3_D" name="Q6_14_3_D" type="text" style="width: 50%;float: left;" placeholder="দিন" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12 Q5_1_8_no_reluctant_unknown">
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_15_2 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_15_3_part">
                                        <label>
                                            <b>6.15.3</b>&nbsp;কত মাস/দিন ঘাড় শক্ত বা ঘাড় ব্যথা ছিল?
                                        </label>
                                        <input value="<?php echo $userInfo->Q6_15_3_M; ?>" id="Q6_15_3_M" name="Q6_15_3_M" type="text" style="width: 50%;float: left;" placeholder="মাস" class="form-control">
                                        <input value="<?php echo $userInfo->Q6_15_3_D; ?>" id="Q6_15_3_D" name="Q6_15_3_D" type="text" style="width: 50%;float: left;" placeholder="দিন" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12 Q5_1_8_no_reluctant_unknown">
                                    <div class="col-md-4 form-group">
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_15_4 == 1962) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_15_5_part">
                                        <label>
                                            <b>6.15.5</b>&nbsp;মৃত্যুকালীন অসুখের সময় মাথার চাঁদি ফুলে গিয়েছিল? (১ বছর বয়সের কম হলে)
                                        </label>
                                        <select id="Q6_15_5" class="form-control" name="Q6_15_5">
                                            <option id="0" value="">নির্বাচন করুন</option>
<?php foreach ($VA_Yes_No_Reluctant_NotApplicable_Unknown as $VA_Yes_No_Reluctant_NotApplicable_Unknown_single) { ?>
...
<?php } ?>
                                ...
                                <div class="col-md-12 Q5_1_8_no_reluctant_unknown">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <select id="Q6_16" class="form-control" name="Q6_16">
                                            <option id="0" value="">নির্বাচন করুন</option>
<?php foreach ($VA_Child_Age as $VA_Child_Age_single) { ?>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_16 != 1948) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_16_less_than_one_year">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_16_1 != 1576) echo " style='display:none'"; ?> class="col-md-3 form-group Q6_16_1_yes">
                                        <label>
                                            <b>6.16.2</b>&nbsp;কতদিন যাবৎ তার খিঁচুনী ছিল?
                                        </label>
                                        <input value="<?php echo $userInfo->Q6_16_2; ?>" id="Q6_16_2" name="Q6_16_2" type="text" placeholder="দিন" class="form-control">
                                    </div>
                                    <div <?php if ($userInfo->Q6_16_1 != 1576) echo " style='display:none'"; ?> class="col-md-3 form-group Q6_16_1_yes">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_17_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_17_2_part">
                                        <label>
                                            <b>6.17.2</b>&nbsp;কতদিন যাবৎ এ অবস্থায় ছিল?
                                        </label>
                                        <input value="<?php echo $userInfo->Q6_17_2_D; ?>" id="Q6_17_2_D" name="Q6_17_2_D" type="text" style="width: 50%;float: left;" placeholder="দিন" class="form-control">
                                        <input value="<?php echo $userInfo->Q6_17_2_H; ?>" id="Q6_17_2_H" name="Q6_17_2_H" type="text" style="width: 50%;float: left;" placeholder="ঘন্টা " class="form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>
...
<?php } ?>
                                ...
                                <div <?php if ($userInfo->Q6_17_3 != 1576) echo " style='display:none'"; ?> class="col-md-12 Q5_1_8_no_reluctant_unknown Q6_17_3_yes">
                                    <div class="col-md-4 form-group">
                                        <label>
                                            <b>6.17.4</b>&nbsp;কতদিন/ঘন্টা যাবৎ অজ্ঞান ছিল?<br/>(Code: 99 = অজানা)
                                        </label>
                                        <input value="<?php echo $userInfo->Q6_17_4_D; ?>" id="Q6_17_4_D" name="Q6_17_4_D" type="text" style="width: 50%;float: left;" placeholder="দিন" class="form-control">
                                        <input value="<?php echo $userInfo->Q6_17_4_H; ?>" id="Q6_17_4_H" name="Q6_17_4_H" type="text" style="width: 50%;float: left;" placeholder="ঘন্টা " class="form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_18_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_18_1_yes">
                                        <label>
...
?>
                                    ...
                                    <div <?php if ($userInfo->Q6_18_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_18_1_yes">
                                        ...
                                        <input value="<?php echo $userInfo->Q6_18_3_Y; ?>" id="Q6_18_3_Y" name="Q6_18_3_Y" type="text" style="width: 33%;float: left;" placeholder="বছর " class="form-control">
                                        <input value="<?php echo $userInfo->Q6_18_3_M; ?>" id="Q6_18_3_M" name="Q6_18_3_M" type="text" style="width: 33%;float: left;" placeholder="মাস " class="form-control">
                                        <input value="<?php echo $userInfo->Q6_18_3_D; ?>" id="Q6_18_3_D" name="Q6_18_3_D" type="text" style="width: 33%;float: left;" placeholder="দিন" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12 Q5_1_8_no_reluctant_unknown">
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_19_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_19_1_yes">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_19_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_19_1_yes">
                                        ...
                                        <input value="<?php echo $userInfo->Q6_19_3; ?>" id="Q6_19_3" name="Q6_19_3" type="text"  placeholder="দিন" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12 Q5_1_8_no_reluctant_unknown">
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_20_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_20_1_yes">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_20_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_20_1_yes">
                                        ...
                                        <input value="<?php echo $userInfo->Q6_20_3; ?>" id="Q6_20_3" name="Q6_20_3" type="text" placeholder="দিন" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12 Q5_1_8_no_reluctant_unknown">
                                    <div class="col-md-4 form-group">
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_20_4b != 1576) echo " style='display:none;'" ?> class="col-md-4 form-group Q6_20_5_part">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q6_21_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_21_1_yes">
                                        <label>
                                            <b>6.21.2</b>&nbsp;মৃত্যুর কতদিন/মাস পুর্বে তার শেষ অস্ত্রোপচার হয়েছিল?
                                            (Code: 99 = অজানা)
                                        </label>
                                        <input value="<?php echo $userInfo->Q6_21_2_M; ?>" id="Q6_21_2_M" name="Q6_21_2_M" type="text" style="width: 50%;float: left;" placeholder="মাস" class="form-control">
                                        <input value="<?php echo $userInfo->Q6_21_2_D; ?>" id="Q6_21_2_D" name="Q6_21_2_D" type="text" style="width: 50%;float: left;" placeholder="দিন" class="form-control">
                                    </div>
                                    <div <?php if ($userInfo->Q6_21_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q6_21_1_yes">
                                        <label>
                                            <b>6.21.3</b>&nbsp; অপারেশন শরীরের কোথায় হয়েছিল?
                                        </label>
                                        <input value="<?php echo $userInfo->Q6_21_3; ?>" id="Q6_21_3" name="Q6_21_3" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12 Q5_1_8_no_reluctant_unknown">
...
<?php } ?>
                                ...
                                <div <?php if ($userInfo->Q7_1 != 1576) echo " style='display:none'"; ?> class="col-md-12 Q5_1_8_no_reluctant_unknown Q7_1_yes">
...
?>
                                ...
                                <div class="col-md-12 Q5_1_8_no_reluctant_unknown">
                                    <div <?php if ($userInfo->Q7_1 != 1576) echo " style='display:none'"; ?> class="col-md-6 form-group Q7_1_yes">
                                        <label><b>7.1.2</b>&nbsp;সর্বশেষ অসুখের সময় শিশুটিকে চিকিৎসার জন্য স্বাস্থ্য প্রতিষ্ঠান</label>
...
?>
                                    ...
                                    <div <?php
                                        if ($userInfo->Q7_1_2 > 1649 && $userInfo->Q7_1_2 < 1938)
                                            echo " style='display:block'";
                                        else
                                            echo " style='display:none'";
                                        ?> class="col-md-6 form-group Q7_1_2_applicable">
                                        <label>
...
?>
                                            ...
                                            <tr><td colspan="2" style="text-align: left;">&nbsp;<p style="color:red;font-size:14px;">Note: বাড়ীতে চিকিৎসা হলে (Skip to 7.3)</p></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                                ...
                                <div <?php
                                    if ($userInfo->Q7_1_2 > 1649 && $userInfo->Q7_1_2 < 1938)
                                        ...
                                        echo " style='display:none'";
                                    ?> class="col-md-12 Q5_1_8_no_reluctant_unknown Q7_1_2_applicable">
                                    <div class="col-md-3 form-group">
                                        <label>
...
<?php foreach ($VA_Yes_No_Reluctant_Unknown as $VA_Yes_No_Reluctant_Unknown_single) { ?>
                                ...
                                <?php
                                if ($userInfo->Q7_2_1_1_DATE == "") {
                                    $userInfo->Q7_2_1_1_DATE = "1900-01-01";
                                }
                                if ($userInfo->Q7_2_1_2_DATE == "") {
                                    $userInfo->Q7_2_1_2_DATE = "1900-01-01";
                                }
                                if ($userInfo->Q7_2_1_3_DATE == "") {
                                    $userInfo->Q7_2_1_3_DATE = "1900-01-01";
                                }
                                ...
                                <div <?php
                                    if ($userInfo->Q7_2 == 1576)
                                        echo " style='display:block'";
                                    else
                                        echo " style='display:none'";
                                    ?> class="col-md-12 Q5_1_8_no_reluctant_unknown Q7_2_yes">
                                    <label>
...
<?php } ?>
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input value="<?php if ($userInfo->Q7_2_1_1_DATE != "1900-01-01") echo $Q7_2_1_1_DATE; ?>" id="Q7_2_1_1_DATE" name="Q7_2_1_1_DATE" autocomplete="off" type="text" class="datepicker form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input value="<?php if ($userInfo->Q7_2_1_2_DATE != "1900-01-01") echo $Q7_2_1_2_DATE; ?>" id="Q7_2_1_2_DATE" name="Q7_2_1_2_DATE" autocomplete="off" type="text" class="datepicker form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>
                                            হাসপাতালে ভর্তির কারণ সমূহ
...
<?php } ?>
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input value="<?php if ($userInfo->Q7_2_1_3_DATE != "1900-01-01") echo $Q7_2_1_3_DATE; ?>" id="Q7_2_1_3_DATE" name="Q7_2_1_3_DATE" autocomplete="off" type="text" class="datepicker form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>
                                            হাসপাতালে ভর্তির কারণ সমূহ
                                ...
                                <div class="col-md-12">
                                    <div <?php
                                        if ($userInfo->Q7_2 == 1576)
                                            ...
                                            echo " style='display:none'";
                                        ?> class="col-md-4 form-group Q5_1_8_no_reluctant_unknown Q7_2_yes">
                                        <label>
...
?>
                                    ...
                                    <div <?php if ($userInfo->Q7_3 != 1826) echo " style='display:none'"; ?> class="col-md-4 form-group Q7_3_health_service_institute">
                                        <label>
                                            <b>7.3.1</b>&nbsp;যদি সে কোন স্বাস্থ্যসেবা প্রতিষ্ঠানে মৃত্যুবরন করে থাকেন তা হলে তার নাম ও ঠিকানা লিখুন:
                                        </label>
                                        <textarea id="Q7_3_1_Hname_Haddress" name="Q7_3_1_Hname_Haddress" class="form-control" style="resize: none;"><?php echo $userInfo->Q7_3_1_Hname_Haddress; ?></textarea>
                                    </div>
                                </div>
                                <div <?php if ($userInfo->Q7_3 != 1826) echo " style='display:none'"; ?> class="col-md-12 Q7_3_health_service_institute">
                                    <div class="col-md-4 form-group">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q7_3_2 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q7_3_2_yes">
                                        <label>
...
?>
                                ...
                                <div <?php if ($userInfo->Q7_3_2 != 1576) echo " style='display:none'"; ?> class="col-md-12 form-group Q7_3_2_yes">
                                    <label>
                                        <b>7.3.4</b> &nbsp;তিনি মৃত্যুর কি কারণ বলেছিলেন? (কারণ সমূহ লিখুন)
                                    </label>
                                    <textarea id="Q7_3_4" class="form-control" name="Q7_3_4"><?php echo $userInfo->Q7_3_4; ?></textarea>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-4 form-group">
                                        <label>
                                            <b>8.1</b>&nbsp;শিশুটির কোন স্বাস্থ্য তথ্য বা ব্যবস্থাপত্র আছে কি?
                                        </label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q8_1 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q8_1_yes">
                                        <label>
                                            <b>8.1.1</b>&nbsp;আমি স্বাস্থ্য তথ্যখানা বা ব্যবস্থাপত্র দেখতে পারি কি?
                                        </label>
...
<?php } ?>
                                ...
                                <div <?php if ($userInfo->Q8_1 != 1576) echo " style='display:none'"; ?> class="col-md-12 form-group Q8_1_yes">
                                    তথ্যখানা থেকে Date, Symptoms, Diagnosis and Treatment লিখুন (সংযুক্ত করুন)
                                </div>
                                <div <?php if ($userInfo->Q8_1 != 1576) echo " style='display:none'"; ?> class="col-md-12 Q8_1_yes">
                                    <div class="col-md-4 form-group">
                                        <label>
                                            Symptoms
                                        </label>
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input value="<?php echo $userInfo->Q8_1_2_weight_1; ?>" id="Q8_1_2_weight_1" name="Q8_1_2_weight_1" type="text" style="width:40%;float: left;" class="form-control" placeholder="গ্রাম"><span></span>
                                        <input value="<?php echo $userInfo->Q8_1_2_weight_2; ?>" id="Q8_1_2_weight_2" name="Q8_1_2_weight_2" type="text" style="width:40%;" class="form-control" placeholder="গ্রাম"><span></span>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="col-md-8 form-group">
...
<?php } ?>
                                ...
                                <div <?php if ($userInfo->Q8_2 != 1576) echo " style='display:none'"; ?> class="col-md-12 Q8_2_yes">
                                    <div class="col-md-4 form-group">
                                        <label>
...
<?php } ?>
                                ...
                                <div <?php if ($userInfo->Q8_2_1 != 1567) echo " style='display:none'"; ?> class="col-md-12 Q8_2_1_yes">
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q8_2_3 != 1576) echo " style='display:none'"; ?> class="col-md-4 form-group Q8_2_3_yes">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q8_3 != 1576) echo " style='display:none'"; ?> class="col-md-3 form-group Q8_3_yes">
                                        <label>
                                    ...
                                    <?php
                                    if ($userInfo->Q8_3_2 == "") {
                                        $userInfo->Q8_3_2 = "1900-01-01";
                                    }

                                    $partsRequire = explode('-', $userInfo->Q8_3_2);
                                    $Q8_3_2 = $partsRequire[2] . '/' . $partsRequire[1] . '/' . $partsRequire[0];
                                    ?>
                                    <div <?php if ($userInfo->Q8_3_1 != 1567) echo " style='display:none'"; ?> class="col-md-3 form-group Q8_3_1_yes">
                                        <label>
                                            <b>8.3.2</b> &nbsp;নিবন্ধণের তারিখ লিখুন
                                        </label>
                                        <input id="Q8_3_2" value="<?php if ($userInfo->Q8_3_2 != "1900-01-01") echo $Q8_3_2; ?>" type="text" class="datepicker form-control" name="Q8_3_2">
                                    </div>
                                    <div <?php if ($userInfo->Q8_3_1 != 1567) echo " style='display:none'"; ?> class="col-md-3 form-group Q8_3_1_yes">
                                        <label>
                                            <b>8.3.3</b>&nbsp;নিবন্ধণ নাম্বার লিখুন
                                        </label>
                                        <input value="<?php echo $userInfo->Q8_3_3; ?>" type="text" class="form-control" id="Q8_3_3" name="Q8_3_3">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <br/>
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input value="<?php if ($userInfo->Q10_DOE != "1900-01-01") echo $Q10_DOE; ?>" name="Q10_DOE" type="text" autocomplete="off" class="datepicker form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
...
?> value="1">complete</option>
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input value="<?php echo $userInfo->I_A; ?>" name="I_A" type="text" class="form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>
                                            Underlying cause (I-B):
                                        </label>

                                        <input value="<?php echo $userInfo->I_B; ?>" name="I_B" type="text" class="form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>
                                            Underlying cause (I-C):
                                        </label>

                                        <input value="<?php echo $userInfo->I_C; ?>" name="I_C" type="text" class="form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>
                                            Underlying cause (I-D):
                                        </label>

                                        <input value="<?php echo $userInfo->I_D; ?>" name="I_D" type="text" class="form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>
                                            Contributory cause (II-A):
                                        </label>

                                        <input value="<?php echo $userInfo->II_A; ?>" name="II_A" type="text" class="form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>
                                            Contributory cause (II-B):
                                        </label>

                                        <input value="<?php echo $userInfo->II_B; ?>" name="II_B" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12">
...
<?php } ?>
    ...
    <script>
                                                        if ($("#Q5_1_8").val() == 1577 || $("#Q5_1_8").val() == 1578 || $("#Q5_1_8").val() == 1579) {
