                            ...
                            <div class="row">
                                ...
                                <div <?php if ($userInfo->Q5_1_3 == 1576) echo " style='display:none;'" ?> class="col-md-12 Q5_1_3_no_reluctant_unknown">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input value="<?php if ($userInfo->Q6_2_4_DATE != "1900-01-01") echo $Q6_2_4_DATE; ?>" autocomplete="off" id="Q6_2_4_DATE" name="Q6_2_4_DATE" type="text" class="datepicker form-control">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <br/>
                                ...
                                <div <?php if ($userInfo->Q5_1_3 == 1576 || $userInfo->Q8_1_2 == 1938 || $userInfo->Q8_1 == 1577 || $userInfo->Q8_1 == 1578 || $userInfo->Q8_1 == 1579 || $userInfo->Q8_2 == 1577 || $userInfo->Q8_2 == 1578 || $userInfo->Q8_2 == 1579) echo " style='display:none;'" ?> class="col-md-12 form-group Q5_1_3_no_reluctant_unknown Q8_1_yes_part Q8_1_2_NoWhereTaken_part Q8_2_yes_part">
                                    ...
                                    <table  class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <select id="Q8_2_1_HOSPITAL_1" name="Q8_2_1_HOSPITAL_1" class="form-control">
                                                        <option id="0" value="">নির্বাচন করুন</option>
...
<?php } ?>
                                            ...
                                            <tr>
                                                <td>
                                                    <select id="Q8_2_1_HOSPITAL_2" name="Q8_2_1_HOSPITAL_2" class="form-control">
                                                        <option id="0" value="">নির্বাচন করুন</option>
                                                        <?php foreach ($VA_Hospital_List as $VA_Hospital_List_single) { ?>
...
<?php } ?>
                                            ...
                                            <tr>
                                                <td>
                                                    <select id="Q8_2_1_HOSPITAL_3" name="Q8_2_1_HOSPITAL_3" class="form-control">
                                                        <option id="0" value="">নির্বাচন করুন</option>
                                                        <?php foreach ($VA_Hospital_List as $VA_Hospital_List_single) { ?>
...
<?php } ?>
                                ...
                                <div <?php if ($userInfo->Q9_2 != 1576) echo " style='display:none;'"; ?> class="col-md-12 Q9_2_part">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input id="Q9_2_VDATE" value="<?php if ($userInfo->Q9_2_VDATE != "1900-01-01") echo $Q9_2_VDATE; ?>" type="text" name="Q9_2_VDATE" autocomplete="off" class="datepicker form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>
                                            Height (cm)
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q9_9_1 != 1567) echo " style='display:none;'"; ?> class="col-md-3 form-group Q9_9_1_no_reluctant_unknown">
                                        ...
                                        <input value="<?php if ($userInfo->Q9_9_2 != "1900-01-01") echo $Q9_9_2; ?>" id="Q9_9_2" name="Q9_9_2" type="text" class="datepicker form-control">
                                    </div>
                                    <div <?php if ($userInfo->Q9_9_1 != 1567) echo " style='display:none;'"; ?> class="col-md-3 form-group Q9_9_1_no_reluctant_unknown">
