                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input value="<?php echo $userInfo->Q3_1_DNAME; ?>" name="Q3_1_DNAME" type="text" class="form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>3.2) RID: </label>
                                        <input value="<?php echo $userInfo->Q3_2_RID; ?>" name="Q3_2_RID" type="text" class="form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>CID</label>
                                        <input value="<?php echo $userInfo->Q3_2_CID; ?>" name="Q3_2_CID" type="text" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input value="<?php echo $userInfo->Q3_4_B_CODE; ?>" name="Q3_4_B_CODE" type="text" class="form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>3.5) মৃতের জন্ম তারিখ (দিন/মাস/বছর):</label>
                                        <input value="<?php if ($userInfo->Q3_5_DOB != "0000-00-00") echo $Q3_5_DOB; ?>" autocomplete="off" name="Q3_5_DOB" type="text" class="datepicker form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>3.6) মৃতের মৃত্যু তারিখ (দিন/মাস/বছর):</label>
                                        <input value="<?php if ($userInfo->Q3_6_DOD != "0000-00-00") echo $Q3_6_DOD; ?>" autocomplete="off" name="Q3_6_DOD" type="text" class="datepicker form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input value="<?php echo $userInfo->Q3_7_AGE_Y; ?>" name="Q3_7_AGE_Y" type="text" class="form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>3.8) মৃতের লিঙ্গ:</label>
                                        <select name="Q3_8_SEX" class="form-control">
                                            <option id="0" value="">নির্বাচন করুন</option>
                                            <?php foreach ($va_gender as $va_gender_single) { ?>
                                                <option <?php if ($userInfo->Q3_8_SEX == $va_gender_single->id) echo ' selected'; ?> value="<?php echo $va_gender_single->id; ?>"><?php echo $va_gender_single->name; ?></option>
                                            <?php } ?>
                                        </select> 
                                    </div>
                                    <div class="col-md-4 form-group">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div <?php if ($userInfo->Q3_9_2_DOM == "0000-00-00") echo " style='display:none;'"; ?> id="Q3_9_2" class="col-md-4 form-group">
                                        <label>3.9.2) বিবাহের তারিখঃ</label>
                                        <input value="<?php if ($userInfo->Q3_9_2_DOM != "0000-00-00") echo $Q3_9_2_DOM; ?>" autocomplete="off" name="Q3_9_2_DOM" id="Q3_9_2_DOM" type="text" class="datepicker form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <select class="form-control" name="Q3_11_CODE">
                                            <option id="0" value="">নির্বাচন করুন</option>
                                            <?php foreach ($VA_Occupation_Type as $VA_Occupation_Type_single) { ?>
                                                <option <?php if ($userInfo->Q3_11_CODE == $VA_Occupation_Type_single->id) echo ' selected'; ?> value="<?php echo $VA_Occupation_Type_single->id; ?>"><?php echo $VA_Occupation_Type_single->name; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div <?php if ($userInfo->FK_SEX == 466) echo " style='display:none;'" ?> class="col-md-12 Q5_1_no_reluctant_unknown_female">
                                ...
                                <div <?php if ($userInfo->FK_SEX == 466) echo " style='display:none;'" ?> class="col-md-12 Q5_1_no_reluctant_unknown_female">
                                    ...
                                    <div id="Q6_1_2" class="col-md-4 form-group">
                                        <label>
                                ...
                                <div <?php if ($userInfo->FK_SEX == 466) echo " style='display:none;'" ?> class="col-md-12 Q5_1_no_reluctant_unknown_female">
                                    <div class="col-md-4 form-group">
                                        ...
                                        ?>
                                        <input value="<?php if ($userInfo->Q6_2_2 != "0000-00-00") echo $Q6_2_2; ?>" autocomplete="off" name="Q6_2_2" type="text" class="datepicker form-control">
                                    ...
                                    <div class="col-md-4 form-group Q6_2_3_Not_Delivery">
                                        <label>
                                ...
                                <div <?php if ($userInfo->FK_SEX == 466) echo " style='display:none;'" ?> class="col-md-12 Q5_1_no_reluctant_unknown_female Q6_2_3_Not_Delivery">
                                    <div class="col-md-4 form-group">
                                ...
                                <div <?php if ($userInfo->FK_SEX == 466) echo " style='display:none;'" ?> class="col-md-12 Q5_1_no_reluctant_unknown_female Q6_2_3_Not_Delivery Q6_2_14_part">
                                    <div class="col-md-4 form-group">
                                        <label>
                                            ডাক্তার
                                        </label>
                                ...
                                <div <?php if ($userInfo->Q7_17_3== 1576) echo " style='display:block;'"; else echo " style='display:none;'"; ?> class="col-md-12 Q7_17_3_yes_part">
                                    <div class="col-md-4 form-group">
                                        <label>
                                ...
                                <div <?php if ($userInfo->Q9_2 != 1576) echo " style='display:none;'"; ?> class="col-md-12 Q9_2_no_reluctant_unknown">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input value="<?php if ($userInfo->Q9_2_1_1_DATE != "0000-00-00") echo $Q9_2_1_1_DATE; ?>" id="Q9_2_1_1_DATE" name="Q9_2_1_1_DATE" autocomplete="off" type="text" class="datepicker form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>
                                ...
                                <div <?php if ($userInfo->Q9_2 != 1576) echo " style='display:none;'"; ?> class="col-md-12 Q9_2_no_reluctant_unknown">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input value="<?php if ($userInfo->Q9_2_1_2_DATE != "0000-00-00") echo $Q9_2_1_2_DATE; ?>" id="Q9_2_1_2_DATE" name="Q9_2_1_2_DATE" autocomplete="off" type="text" class="datepicker form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>
                                            হাসপাতালে ভর্তির কারণ সমূহ
                                ...
                                <div <?php if ($userInfo->Q9_2 != 1576) echo " style='display:none;'"; ?> class="col-md-12 Q9_2_no_reluctant_unknown">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input value="<?php if ($userInfo->Q9_2_1_3_DATE != "0000-00-00") echo $Q9_2_1_3_DATE; ?>" id="Q9_2_1_3_DATE" name="Q9_2_1_3_DATE" autocomplete="off" type="text" class="datepicker form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>
                                            হাসপাতালে ভর্তির কারণ সমূহ
                                ...
                                <div <?php if ($userInfo->Q10_1_1 != 1567) echo " style='display:none;'"; ?> class="col-md-12 Q10_1_1_part">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input id="Q10_1_1_VDATE" value="<?php if ($userInfo->Q10_1_1_VDATE != "0000-00-00") echo $Q10_1_1_VDATE; ?>" type="text" name="Q10_1_1_VDATE" autocomplete="off" class="datepicker form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>
                                            Height (cm)
                                ...
                                <div class="col-md-12">
                                    <div <?php if ($userInfo->Q10_1 == 1577 || $userInfo->Q10_1 == 1578 || $userInfo->Q10_1 == 1579 || $userInfo->Q10_1_1 == 1568) echo " style='display:block;'";
                                else echo " style='display:none;'"; ?> class="col-md-4 form-group Q10_2_part">
                                        <label>
...
<?php } ?>
                                    ...
                                    <div <?php if ($userInfo->Q10_3_1_DRS != 1567) echo " style='display:none;'"; ?> class="col-md-4 form-group Q10_3_1_DRS_no_reluctant_unknown">
                                        ...
                                        <input value="<?php if ($userInfo->Q10_3_2_DRD != "0000-00-00") echo $Q10_3_2_DRD; ?>" id="Q10_3_2_DRD" name="Q10_3_2_DRD" type="text" autocomplete="off" class="datepicker form-control">
                                    </div>
                                    <div <?php if ($userInfo->Q10_3_1_DRS != 1567) echo " style='display:none;'"; ?> class="col-md-4 form-group Q10_3_1_DRS_no_reluctant_unknown">
                                        <label>
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input value="<?php if ($userInfo->Q11_DOE != "0000-00-00") echo $Q11_DOE; ?>" name="Q11_DOE" type="text" autocomplete="off" class="datepicker form-control">
                                    </div>
                                    <div class="col-md-4 form-group">
