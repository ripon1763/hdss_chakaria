                    ...
                    <!-- SmartWizard html -->
                                    ...
                                    <div class="form-group">
                                        <label for="email">Any Asset add during this period?</label>
                                         ...
                                         <select name="assetType" id="assetType" class="form-control" required style="">
                                             ...
                                             <option <?php if ($any_asset == 3) { echo "selected=selected"; } ?> value="3">Not available</option>
                                         </select>
                            ...
                            <div class="assetHistory" style="padding-left: 20px; padding-right: 20px">
                             ...
                             <div class="box-footer" style="margin-left: 10px">
                                ...
                                <a class="btn btn-success" href="<?php echo base_url().'householdvisit/interview?baseID='.$baseID.'#interview' ?>" class="">Previous </a>
