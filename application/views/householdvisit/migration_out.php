                    ...
                    <!-- SmartWizard html -->
                            ...
                            <div id="migout" style="padding-left: 20px; padding-right: 20px">
                                    ...
                                    <div class="form-group">
                                        <label for="email">Any movement/migration out ? </label>
                                         ...
                                         <select name="migoutType" id="migoutType" class="form-control" required style="">
											 ...
											 <option <?php if ($any_migration_out == 3) { echo "selected=selected"; } ?> value="3">Not available</option>
                                         </select>
                             ...
                             <div class="box-footer" style="margin-left: 10px">
                                ...
                                <input type="submit" class="btn btn-danger" name="submit" value="Save & Complete" />
