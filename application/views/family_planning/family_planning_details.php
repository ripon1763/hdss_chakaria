...
<form action="<?php echo base_url() . 'family_planning/addNewFamilyPlanning?baseID=' . $baseID ?>" id="myForm" role="form" data-toggle="validator" method="post" accept-charset="utf-8">
    <!-- SmartWizard html -->
    <div id="asset" style="padding-left: 20px; padding-right: 20px">
        <h4>Family planning Details</h4>
        <div class="row">
            <div class="col-md-4">
                <p>Household Code : <?php echo $householdcode ?></p>
            </div>
            <div class="col-md-4">
                <p>Member Info :  <?php echo $member_code . ' - ' . $member_name ?></p>
            </div>
            <div class="col-md-4">
                        ...
                        <select name="maritial_status" id="maritial_status" class="form-control" required>
                            ...
                            if (!empty($marital_status_typ)) {
                                foreach ($marital_status_typ as $marital_status_typ_single) {
                                    ?>
                                    <option <?php
                                    if ($fk_marital_status == $marital_status_typ_single->id) {
                                        echo "selected=selected";
                                    }
                                    ?>  value="<?php echo $marital_status_typ_single->id ?>"><?php echo $marital_status_typ_single->code . '-' . $marital_status_typ_single->name ?></option>
                ...
                <div class="row">
                            ...
                            <select name="husband_living_place" id="husband_living_place" class="form-control">
                                ...
                                if (!empty($husband_staying_place)) {
                                    foreach ($husband_staying_place as $husband_staying_place_single) {
                                        ?>
                                        <option  value="<?php echo $husband_staying_place_single->id ?>"><?php echo $husband_staying_place_single->code . '-' . $husband_staying_place_single->name ?></option>
                            ...
                            <select name="birth_control_method" id="birth_control_method" class="form-control">
                                ...
                                if (!empty($birth_control_method)) {
                                    foreach ($birth_control_method as $birth_control_method_single) {
                                        ?>
                                        <option  value="<?php echo $birth_control_method_single->id ?>"><?php echo $birth_control_method_single->code . '-' . $birth_control_method_single->name ?></option>
                    ...
                    <div style="display:none;" class="col-md-12 birth_control_method_other_part">
                        <div class="form-group">
                            ...
                            <input name="birth_control_method_other_value" id="birth_control_method_other_value" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-6 martial_status_dependent_part current_pregnancy_status_non_yes_part birth_control_method_usage_status_yes_part">
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <input placeholder="বছর" name="continuously_using_how_many_year" id="continuously_using_how_many_year" class="form-control">
                                </div>
                                <div class="col-md-3">
                                    <input placeholder="মাস" name="continuously_using_how_many_month" id="continuously_using_how_many_month" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <select name="birth_control_method_suggestion_from_where" id="birth_control_method_suggestion_from_where" class="form-control">
                                ...
                                if (!empty($method_taken_from)) {
                                    foreach ($method_taken_from as $method_taken_from_single) {
                                        ?>
                                        <option  value="<?php echo $method_taken_from_single->id ?>"><?php echo $method_taken_from_single->code . '-' . $method_taken_from_single->name ?></option>
                    ...
                    <div style="display:none;" class="col-md-12 birth_control_method_suggestion_from_where_other_part">
                        <div class="form-group">
                            ...
                            <input name="birth_control_method_suggestion_from_where_other_value" id="birth_control_method_suggestion_from_where_other_value" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-12 martial_status_dependent_part current_pregnancy_status_non_yes_part birth_control_method_usage_status_yes_part">
                        <div class="form-group">
                            ...
                            <select name="whose_decision" id="whose_decision" class="form-control">
                                ...
                                if (!empty($birth_control_method_taking_decision)) {
                                    foreach ($birth_control_method_taking_decision as $birth_control_method_taking_decision_single) {
                                        ?>
                                        <option  value="<?php echo $birth_control_method_taking_decision_single->id ?>"><?php echo $birth_control_method_taking_decision_single->code . '-' . $birth_control_method_taking_decision_single->name ?></option>
                    ...
                    <div style="display:none;" class="col-md-12 whose_decision_other_part">
                        <div class="form-group">
                            ...
                            <input name="whose_decision_other_value" id="whose_decision_other_value" class="form-control">
                        </div>
                    </div>
                    ...
                    <div style="display:none;" class="col-md-6 reason_behind_not_using_other_part">
                        <div class="form-group">
                            ...
                            <input name="reason_behind_not_using_other_value" id="reason_behind_not_using_other_value" class="form-control">
                        </div>
                    </div>
                    ...
                    <div style="display:none;" class="col-md-6 reason_behind_not_having_future_desire_other_part">
                        <div class="form-group">
                            ...
                            <input name="reason_behind_not_having_future_desire_other_value" id="reason_behind_not_having_future_desire_other_value" class="form-control">
                        </div>
                    </div>
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="checkbox">
                                    <label><input name="available_govt_hospital" type="checkbox" value="1">সরকারি হাসপাতাল / মেডিকেল কলেজ হাসপাতাল</label>
                                </div>
                                <div class="checkbox">
                                    <label><input name="available_central_dist_hospital" type="checkbox" value="2">জেলা সদর হাসপাতাল</label>
                                </div>
                                <div class="checkbox">
                                    <label><input name="available_matri_sonod" type="checkbox" value="3">মাতৃসদন/মাতৃমঙ্গল/মেটারনিটি</label>
                                </div>
                                <div class="checkbox">
                                    <label><input name="available_ngo_facility" type="checkbox" value="4">NGO facility supported by UPHCSDP</label>
                                </div>
                                <div class="checkbox">
                                    <label><input name="available_upazilla_sasthokendro" type="checkbox" value="5">উপজেলা স্ব্যাস্থকেন্দ্র</label>
                                </div>
                                <div class="checkbox">
                                    <label><input name="available_union_sastho_poribar_kollan_kendro" type="checkbox" value="6">ইউনিয়ন স্ব্যাস্থ ও পরিবারকল্যান কেন্দ্র</label>
                                </div>
                                <div class="checkbox">
                                    <label><input name="available_satellite_clinic" type="checkbox" value="7">স্যাটেলাইটক্লিনিক/ইপিআই প্রোগ্রাম</label>
                                </div>
                                <div class="checkbox">
                                    <label><input name="available_community_clinic" type="checkbox" value="8">কমিউনিটি ক্লিনিক</label>
                                </div>
                                <div class="checkbox">
                                    <label><input name="available_ngo_and_satellite_clinic" type="checkbox" value="9">এনজিও স্যাটেলাইট ক্লিনিক</label>
                                </div>
                                <div class="checkbox">
                                    <label><input name="available_ngo_and_static_clinic" type="checkbox" value="10">এনজিও স্ট্যাটিক ক্লিনিক</label>
                                </div>
                                <div class="checkbox">
                                    <label><input name="available_private_hospital" type="checkbox" value="11">প্রাইভেট হাসপাতাল/ক্লিনিক</label>
                                </div>
                                <div class="checkbox">
                                    <label><input name="available_mbbs_doctor_chamber" type="checkbox" value="12">এমবিবিএস ডাক্তার চেম্বার</label>
                                </div>
                                <div class="checkbox">
                                    <label><input name="available_doctor_without_degrees" type="checkbox" value="13">ডিগ্রীধারি ডাক্তারের চেম্বারেনা</label>
                                </div>
                                <div class="checkbox">
                                    <label><input name="available_pharmacy" type="checkbox" value="14">ফার্মেসী</label>
                                </div>
                                <div class="checkbox">
                                    <label><input name="available_other" id="available_other" type="checkbox" value="15">অন্যান্য (উল্লেখ করুন)</label>
                                </div>
                            </div>
                        </div>
                        <div style="display:none;" class="col-md-6 available_other_part">
                            <div class="form-group">
                                ...
                                <input name="available_other_value" id="available_other_value" class="form-control">
                            </div>
                        </div>
                    </fieldset>
                </div>
                ...
                <div class="row">
                            ...
                            <select name="taking_desire_more_children" id="taking_desire_more_children" class="form-control">
                                ...
                                if (!empty($yes_no_pregnant_dont_know)) {
                                    foreach ($yes_no_pregnant_dont_know as $yes_no_pregnant_dont_know_single) {
                                        ?>
                                        <option  value="<?php echo $yes_no_pregnant_dont_know_single->id ?>"><?php echo $yes_no_pregnant_dont_know_single->code . '-' . $yes_no_pregnant_dont_know_single->name ?></option>
                    ...
                    <div class="col-md-6 martial_status_dependent_part taking_desire_more_children_after_year_part">
                        <div class="form-group">
                            ...
                            <input placeholder="বছর" type="text" name="taking_desire_more_children_after_year" id="taking_desire_more_children_after_year" class="form-control">
                        </div>
                    </div>
                            ...
                            <select name="how_many_children_you_want" id="how_many_children_you_want" class="form-control">
                                ...
                                if (!empty($how_many_children)) {
                                    foreach ($how_many_children as $how_many_children_single) {
                                        ?>
                                        <option  value="<?php echo $how_many_children_single->id ?>"><?php echo $how_many_children_single->code . '-' . $how_many_children_single->name ?></option>
                            ...
                            <select name="alive_children" id="alive_children" class="form-control">
                                ...
                                if (!empty($alive_children)) {
                                    foreach ($alive_children as $alive_children_single) {
                                        ?>
                                        <option  value="<?php echo $alive_children_single->id ?>"><?php echo $alive_children_single->code . '-' . $alive_children_single->name ?></option>
                    ...
                    <div style="display:none;" class="col-md-6 alive_boy_number_part">
                        <div class="form-group">
                            ...
                            <input name="alive_boy_number" id="alive_boy_number" class="form-control">
                        </div>
                    </div>
                    <div style="display:none;" class="col-md-6 alive_girl_number_part">
                        <div class="form-group">
                            ...
                            <input name="alive_girl_number" id="alive_girl_number" class="form-control">
                        </div>
                    </div>
                            ...
                            <select name="alive_children_yes_availability" id="alive_children_yes_availability" class="form-control">
                                ...
                                if (!empty($no_one_how_many_others)) {
                                    foreach ($no_one_how_many_others as $no_one_how_many_others_single) {
                                        ?>
                                        <option  value="<?php echo $no_one_how_many_others_single->id ?>"><?php echo $no_one_how_many_others_single->code . '-' . $no_one_how_many_others_single->name ?></option>
                    ...
                    <div style="display:none;" class="col-md-12 alive_children_yes_availability_other_part">
                        <div class="form-group">
                            ...
                            <input placeholder="অন্যান্য" name="alive_children_yes_availability_other_value" id="alive_children_yes_availability_other_value" class="form-control">
                        </div>
                    </div>
                    <div style="display:none;" class="col-md-12 alive_children_yes_availability_how_many_part">
                        <div class="form-group">
                            ...
                            <input placeholder="কতজন" name="alive_children_yes_availability_how_many" id="alive_children_yes_availability_how_many" class="form-control">
                        </div>
                    </div>
                    ...
                    <div style="display:none;" class="col-md-12 alive_children_no_availability_other_part">
                        <div class="form-group">
                            ...
                            <input placeholder="অন্যান্য" name="alive_children_no_availability_other_value" id="alive_children_no_availability_other_value" class="form-control">
                        </div>
                    </div>
                    ...
                    <div style="display:none;" class="col-md-12 alive_children_no_availability_how_many_part">
                        <div class="form-group">
                            ...
                            <input placeholder="কতজন" name="alive_children_no_availability_how_many" id="alive_children_no_availability_how_many" class="form-control">
                        </div>
                    </div>
                            ...
                            <select name="how_many_male_female_children" id="how_many_male_female_children" class="form-control">
                                ...
                                if (!empty($boy_girl_anyone)) {
                                    foreach ($boy_girl_anyone as $boy_girl_anyone_single) {
                                        ?>
                                        <option  value="<?php echo $boy_girl_anyone_single->id ?>"><?php echo $boy_girl_anyone_single->code . '-' . $boy_girl_anyone_single->name ?></option>
                    ...
                    <div style="display:none;" class="col-md-4 how_many_male_part">
                        <div class="form-group">
                            ...
                            <input name="how_many_male" id="how_many_male" class="form-control">
                        </div>
                    </div>
                    <div style="display:none;" class="col-md-4 how_many_female_part">
                        <div class="form-group">
                            ...
                            <input name="how_many_female" id="how_many_female" class="form-control">
                        </div>
                    </div>
                    <div style="display:none;" class="col-md-4 how_many_any_part">
                        <div class="form-group">
                            <label for="how_many_any">যে কোন<span style="color:red;">*</span></label>
                            <input name="how_many_any" id="how_many_any" class="form-control">
                        </div>
                    </div>
                    <div style="display:none;" class="col-md-4 how_many_male_female_children_other_part">
                        <div class="form-group">
                            ...
                            <input name="how_many_male_female_children_other_value" id="how_many_male_female_children_other_value" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
    ...
    $("#current_pregnancy_status").change(function () {
        $(this).find("option:selected").each(function () {
            ...
            if (optionValue == 331) {
                ...
                $('#birth_control_method').val('').trigger('change');
                $('#birth_control_method_suggestion_from_where').val('').trigger('change');
                $('#whose_decision').val('').trigger('change');
                $('#reason_behind_not_using').val('').trigger('change');
