...
<form action="<?php echo base_url() . 'memberChildIllness/editChildIllnessDetails?baseID=' . $baseID ?>" id="myForm" role="form" data-toggle="validator" method="post" accept-charset="utf-8">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <?php echo $ChildIllnessRecord->member_code . '-' . $ChildIllnessRecord->member_name ?>
                    </div>
                </div>
            </div>
    ...
    <?php if ($ChildIllnessRecord->id > 0) { ?>

        <div class="box-footer" style="margin-left: 10px">
            <input type="hidden" name="household_master_id_sub" value="<?php echo $household_master_id_sub ?>">
            <input type="hidden" name="round_master_id" value="<?php echo $ChildIllnessRecord->round_master_id ?>">
            <input type="hidden" name="member_master_id" value="<?php echo $ChildIllnessRecord->member_master_id ?>">
            <input type="hidden" name="immunizationID" value="<?php echo $ChildIllnessRecord->id ?>">
