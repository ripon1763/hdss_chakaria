...
class Lookup_master extends BaseController
{
    /**
     * This is default constructor of the class
     */
	 
	public $controller = "lookup_master";
    ...
    public function index()
    {
            ...
            $data['userRecords'] = $this->modelName->listing($this->config->item('lookMasterTable'));
    ...
    function addNewList()
    {
		   ...
		   if($this->form_validation->run() == FALSE)
            ...
            else
            {
				...
				$result = $this->modelName->addNewList($IdInfo,$this->config->item('lookMasterTable'));
    ...
    function editOld($id = NULL)
    {
		    ...
		    $this->global['menu'] =  $this->menuModel->getMenu($this->role);
            $data['userInfo'] = $this->modelName->getListInfo($id,$this->config->item('lookMasterTable'));
    ...
    function editList()
    {
            ...
            else
            {
                ...
                $IDInfo = array();
                $IDInfo = array( 'name'=> $name,'code'=> $code,'active'=>$active,'description'=>$description,'updatedBy'=>$this->vendorId, 'updatedOn'=>date('Y-m-d H:i:s'));
                
                $result = $this->modelName->editList($IDInfo, $id,$this->config->item('lookMasterTable'));
