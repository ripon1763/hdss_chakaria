...
class Country extends BaseController
{
	...
	public $pageTitle = 'Country Management';
	public $pageShortName = 'Country';
    ...
    public function index()
    {
            ...
            $data['userRecords'] = $this->modelName->listingdiv($this->config->item('countryTable'));
    ...
    function addNewList()
    {
            ...
            $this->form_validation->set_rules('name','Country Name','trim|required|max_length[255]|xss_clean');
            $this->form_validation->set_rules('code','Country Code','trim|required|max_length[10]|xss_clean');
		   ...
		   if($this->form_validation->run() == FALSE)
            ...
            else
            {
				...
				$result = $this->modelName->addNewList($IdInfo,$this->config->item('countryTable'));
    ...
    function editOld($id = NULL)
    {
		    ...
		    $this->global['menu'] =  $this->menuModel->getMenu($this->role);
            $data['userInfo'] = $this->modelName->getListInfoDiv($id,$this->config->item('countryTable'));
    ...
    function editList()
    {
            ...
            else
            {
                ...
                $result = $this->modelName->editList($IDInfo, $id,$this->config->item('countryTable'));
