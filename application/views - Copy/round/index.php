<div class="content-wrapper">
    ...
    <section class="content <?php if ($addPerm == 1): ?> <?php if ($roundNo == 0): ?> content-margin <?php else : echo "margin_need"; endif; else : echo "margin_need"; endif;  ?>">
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box-body">
                   <table id="UnitList" class="table table-bordered table-striped">
                    ...
                    <tr>
                      ...
                      <td><?php echo $record->roundNo ?></td>
                      <td><?php echo date('j F Y', strtotime($record->startDate)) ?></td>
                      <td><?php if ($record->endDate != '') { echo date('j F Y', strtotime($record->endDate)); } ?></td>
