                                    ...
                                    <div class="row">
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												<input type="number" class="form-control required" id="birth_weight"  name="birth_weight" value="0.00" step=".01" required="required">
											</div>
										</div> 
										...
										<div class="col-md-3">
											<div class="form-group">
												<label for="Item Name">Father code  <span style="color:red">*</span></label>
										...
										<div class="col-md-3">
											<div class="form-group">
												<label for="Item Name">Mother code <span style="color:red">*</span></label>
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-md-6 manyTimesChild">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control afterTotalTimesChild" id="afterTotalTimesChild"  name="afterTotalTimesChild">
                                                </div>
                                            </div>
                                         ...
                                         <div class="row manyTimesChild">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control " name="childFirstVisitDays" >
                                                </div>
                                            </div>
                                             <div class="col-md-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <label for="Active">Number of days visit(Days only)</label>
                                                    <input type="number" class="form-control " name="childSecondVisitDays" >
                                                </div>
                                            </div>
