                    ...
                    <form role="form" action="<?php echo base_url().$controller.'/'.$actionMethod.'?baseID='.$baseID ?>" method="post" id="editUser" role="form">
                        <div class="box-body">
						    ...
						    <div class="row">
							    ...
							    <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="role" name="slumID" required>
                                           <option value="">Select upazila</option>
                                            ...
                                            if(!empty($slum))
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <option <?php if ($slumID == $slum->id ) { echo "selected=selected";} ?> value="<?php echo $slum->id ?>"><?php echo $slum->name ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="Item Name">Area Code</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="Item Name">Area Name</label>
