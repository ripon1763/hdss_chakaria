                    ...
                    <form role="form" action="<?php echo base_url().$controller.'/'.$actionMethod.'?baseID='.$baseID ?>" method="post" id="editUser" role="form">
                        <div class="box-body">
						    ...
						    <div class="row">
							    ...
							    <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="role" name="districtID" required>
                                           <option value="">Select district</option>
                                            ...
                                            if(!empty($district))
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <option <?php if ($districtID == $district->id ) { echo "selected=selected";} ?> value="<?php echo $district->id ?>"><?php echo $district->name ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="Item Name">Upazila Code</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="Item Name">Upazila Name</label>
