						    ...
						    <div class="row">
							    ...
							    <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="role" name="divisionID" required>
                                           <option value="">Select Division</option>
                                            ...
                                            if(!empty($division))
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <option <?php if ($divisionID == $division->id ) { echo "selected=selected";} ?> value="<?php echo $division->id ?>"><?php echo $division->name ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="Item Name">District Code</label>
										<input type="hidden"  name="id" value="<?php echo $id ?>">
                                        <input type="text" class="form-control required" id="code"  name="code" value="<?php echo $code ?>" maxlength="255">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="Item Name">District Name</label>
