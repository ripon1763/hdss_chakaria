                                ...
                                <div id="form-step-0" role="form" data-toggle="validator">
                                    <div class="row">
                                     ...
                                     <legend class="scheduler-border"><?php if ($sexCode==1) { echo "Bride ";} else { echo "Groom "; } ?>details</legend>
									    ...
									    <div class="col-md-4">
											<div class="form-group">
												<label for="Active"><?php if ($sexCode==1) { echo "Bride ";} else { echo "Groom "; } ?>Member code (blank if not DSS member) <input type="reset" id="reset" class="btn btn-danger" name="reset" value="Reset" /></label>
