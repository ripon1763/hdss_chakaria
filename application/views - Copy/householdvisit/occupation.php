                                ...
                                <div class="table-responsive">
                                 <table class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td class="pull-right"> <a title="Add Occupation" href="<?php echo base_url().'memberOccupation/addOccupation/'.$presentMember->id.'?household_master_id='.$presentMember->household_master_id_hh.'&&baseID='.$baseID.'#occupation'  ?>" class="btn btn-info"> <i class="fa fa-plus" aria-hidden="true"></i> education </a></td>
