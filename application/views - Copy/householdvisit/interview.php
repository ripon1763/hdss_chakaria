                    ...
                    <!-- SmartWizard html -->
                            ...
                            <div id="interview" style="padding-left: 20px; padding-right: 20px">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" value="<?php echo $interview_date ?>" data-provide="datepicker-inline" name="interview_date" required="required">
                             ...
                             <div class="box-footer" style="margin-left: 10px">
                                ...
                                <a class="btn btn-success" href="<?php echo base_url().'householdvisit/death?baseID='.$baseID.'#death' ?>" class="">Previous </a>
