                               ...
                               <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="bariwallaName"  name="bariwallaName" value="<?php echo $bariwalla_name ?>" maxlength="255" required="required">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="bariNumber"  name="bariNumber" value="<?php echo $barino ?>" minlength="5" maxlength="10" size="10" required="required">
                                    </div>
                                </div>
                                 ...
                                 <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $household_head_name ?>" class="form-control required" id="headName"  name="headName" maxlength="255" required="required">
                                    </div>
                                </div>
                                 ...
                                 <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="livingYear"  name="livingYear" value="<?php echo $longlivy ?>" minlength="1" maxlength="2" size="10" required="required">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="Item Name">How long living here (Month)</label>
                                        <input type="text" class="form-control required" id="livingMonth"  name="livingMonth" value="<?php echo $longlivm ?>" minlength="1" maxlength="2" size="10" required="required">
                                    </div>
                                </div>
                                 <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="Item Name">How long ago left to slum</label>
                                        <input type="text" class="form-control required" id="leftSlum"  name="leftSlum" minlength="1" value="<?php echo $leftpad ?>" maxlength="2" size="10" required="required">
                                    </div>
                                </div>
