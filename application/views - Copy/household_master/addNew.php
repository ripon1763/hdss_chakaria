                               ...
                               <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="bariNumber"  name="bariNumber" minlength="4" maxlength="5" size="10" required="required">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="contactNumber"  name="contactNumber" maxlength="11" required="required">
                                    </div>
                                </div>
