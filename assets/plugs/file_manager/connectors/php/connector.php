...
$opts = array(
	...
	'URL'             => 'http://localhost/rte-fileupload/files/', // root directory URL. It is best to set this to an absolute path.
	'rootAlias'       => 'Home',       // display this instead of root directory name
	//'uploadAllow'   => array('images/*'),			//'uploadAllow'  => array('image', 'application/x-shockwave-flash'),
	//'uploadDeny'    => array('all'),				//'uploadDeny'   => array('all'),
	//'uploadOrder'   => 'deny,allow'				//'uploadOrder'  => 'deny,allow'
