...
$(".addmore").on('click',function(){
    ...
    data +="<td><input class='form-control' type='text' id='countryname_"+i+"' name='countryname[]'/></td> <td><input class='form-control' type='text' id='country_no_"+i+"' name='country_no[]'/></td><td><input class='form-control' onfocusout='myFunction()' type='text' id='description_"+i+"' name='description[]'/></td><td><input class='form-control' type='text' id='phone_code_"+i+"' name='phone_code[]'/></td><td><input class='form-control' type='text' id='country_code_"+i+"' name='country_code[]'/></td><td><input class='form-control' type='text' id='unit_cost_"+i+"' name='phone_code[]'/></td><td><input class='form-control' type='text' id='total_cost_"+i+"' name='phone_code[]'/></td></tr>";
	$('table').append(data);
	row = i ;
	$('#countryname_'+i).autocomplete({
  	source: function( request, response ) {
  		$.ajax({
  			url : "http://localhost:81/newadmin/requisition/getItemInfoFromAjax2/",
  			dataType: "json",
  			method: 'post',
			data: {
